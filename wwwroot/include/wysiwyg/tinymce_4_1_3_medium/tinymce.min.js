...
tinymce.init({valid_elements:'*[*]', menubar: false, statusbar: false, allow_events: true, relative_urls : false, remove_script_host : true, document_base_url : "/", convert_urls : true, selector: 'textarea.el_load_wysiwyg', plugins: 'directionality lists table advlist hr link textcolor visualchars searchreplace code preview image media charmap anchor insertdatetime print textpattern fullscreen wordcount visualblocks nonbreaking template readmore htmlinput', toolbar: 'ltr rtl bold  italic underline | fontsizeselect link unlink forecolor backcolor | alignleft aligncenter alignright alignjustify bullist numlist | code preview fullscreen', content_css: '../../../client/style/global.css' });
