...
async function el_RestoreContent(obj, ContentId)
{
	var OkClick = await el_Confirm(ContentLanguageVariant.Restore);
    if (OkClick)
	{
        ...
        xmlhttp.open("GET", ElanatVariant.AdminDirectoryPath + "/recycle_bin/action/ActiveContent.aspx?content_id=" + ContentId, false);
        xmlhttp.send();
    }
    else
	    return false;
...
async function el_ActiveSelectedContent()
{
    ...
    if (OkClick)
	{
        ...
        while (i < ArrayContentIdLength)
		{
            ...
            xmlhttp.open("GET", ElanatVariant.AdminDirectoryPath + "/recycle_bin/action/ActiveContent.aspx?content_id=" + ArrayContentId[i], false);
            xmlhttp.send();
            i++;
        }
    }
...
async function el_InactiveContent(obj, ContentId)
{
    ...
    if (OkClick)
	{
        ...
        xmlhttp.open("GET", ElanatVariant.AdminDirectoryPath + "/recycle_bin/action/InactiveContent.aspx?content_id=" + ContentId, false);
        xmlhttp.send();
    }
    else
	    return false;
...
async function el_InactiveSelectedContent()
{
    ...
    if (OkClick)
	{
        ...
        while (i < ArrayContentIdLength)
		{
            ...
            xmlhttp.open("GET", ElanatVariant.AdminDirectoryPath + "/recycle_bin/action/InactiveContent.aspx?content_id=" + ArrayContentId[i], false);
            xmlhttp.send();
            i++;
        }
    }
...
async function el_DeleteContent(obj, ContentId)
{
    ...
    if (OkClick)
	{
        ...
        xmlhttp.open("GET", ElanatVariant.AdminDirectoryPath + "/recycle_bin/action/DeleteTrashContent.aspx?content_id=" + ContentId, false);
        xmlhttp.send();
    }
    else
	    return false;
...
async function el_DeleteSelectedContent()
{
    ...
    if (OkClick)
	{
        ...
        while (i < ArrayContentIdLength) 
		{
            ...
            xmlhttp.open("GET", ElanatVariant.AdminDirectoryPath + "/recycle_bin/action/DeleteTrashContent.aspx?content_id=" + ArrayContentId[i], false);
            xmlhttp.send();
            i++;
        }
    }
...
function el_ViewContent(ContentId)
{
	if (!document.getElementById("div_ContentViewMore" + ContentId))
	{
        ...
        xmlhttp.open("GET", ElanatVariant.AdminDirectoryPath + "/recycle_bin/action/GetContentViewMore.aspx?content_id=" + ContentId, false);
        xmlhttp.send();
    }
    else
...
function el_SearchContent()
{
    ...
    if (SearchValue != "")
	{
        ...
        xmlhttp.open("GET", ElanatVariant.AdminDirectoryPath + "/recycle_bin/action/GetContentList.aspx?search=" + SearchValue, false);
        xmlhttp.send();
    }
}
...
function el_SortContent(ColumnName, SearchedItem, IsDesc)
{
    ...
    xmlhttp.open("GET", ElanatVariant.AdminDirectoryPath + "/recycle_bin/action/GetContentList.aspx?column_name=" + ColumnName + "&is_desc=" + SortType + SearchValue, false);
    xmlhttp.send();
}
