<%@ Page Controller="Elanat.ActionEditContentReplyController" Model="Elanat.ActionEditContentReplyModel" %><!DOCTYPE html>
...
<body onload="el_PartPageLoad();">
    <form id="frm_ActionEditContentReply" method="post" action="<%=Elanat.AspxHtmlValue.AdminPath()%>/content_reply/action/EditContentReply.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveContentReply" name="btn_SaveContentReply" type="submit" class="el_button_input" value="<%=model.SaveContentReplyLanguage%>" onclick="el_AjaxPostBack(this, true, 'frm_ActionEditContentReply')" />
            </div>
        </div>
