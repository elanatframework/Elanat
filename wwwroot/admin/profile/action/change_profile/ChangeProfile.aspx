<%@ Page Controller="Elanat.ActionChangeProfileController" Model="Elanat.ActionChangeProfileModel" %><!DOCTYPE html>
...
<body onload="el_RunAction(); el_PartPageLoad();">
    ...
    <form id="frm_ActionChangeProfile" method="post" action="<%=Elanat.AspxHtmlValue.AdminPath()%>/profile/action/change_profile/ChangeProfile.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_ChangeProfile" name="btn_ChangeProfile" type="submit" class="el_button_input" value="<%=model.ChangeProfileLanguage%>" onclick="el_AjaxPostBack(this, true, 'frm_ActionChangeProfile')" />
            </div>
        </div>
