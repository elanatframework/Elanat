function el_SearchFootPrint() 
{
    ...
    if (SearchValue != "")
	{
        ...
        xmlhttp.open("GET", ElanatVariant.SitePath + "page/member/user_foot_print/action/GetUserFootPrintList.aspx?search=" + SearchValue, false);
        xmlhttp.send();
    }
}
...
function el_SortFootPrint(ColumnName, SearchedItem, IsDesc) 
{
    ...
    xmlhttp.open("GET", ElanatVariant.SitePath + "page/member/user_foot_print/action/GetUserFootPrintList.aspx?column_name=" + ColumnName + "&is_desc=" + SortType + SearchValue, false);
    xmlhttp.send();
}