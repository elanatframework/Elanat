function el_SearchContent() 
{
    ...
    if (SearchValue != "")
    {
        ...
        xmlhttp.open("GET", ElanatVariant.SitePath + "page/member/user_content/action/GetUserContentList.aspx?search=" + SearchValue, false);
        xmlhttp.send();
    }
}
...
function el_SortContent(ColumnName, SearchedItem, IsDesc) 
{
    ...
    xmlhttp.open("GET", ElanatVariant.SitePath + "page/member/user_content/action/GetUserContentList.aspx?column_name=" + ColumnName + "&is_desc=" + SortType + SearchValue, false);
    xmlhttp.send();
}