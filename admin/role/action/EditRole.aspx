<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditRole.aspx.cs" Inherits="elanat.ActionEditRole" %><!DOCTYPE html>
...
<body onload="el_PartPageLoad();">
    <form id="frm_ActionEditRole" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/role/action/EditRole.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveRole" name="btn_SaveRole" type="submit" class="el_button_input" value="<%=model.SaveRoleLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionEditRole')" />
            </div>
        </div>
