...
namespace elanat
{
    public class ActionEditRoleModel
    {
        ...
        public void SaveRole()
        {
            ...
            if (CurrentRoleName != dur.RoleName)
                System.IO.Directory.Move(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/elanat_system_data/role_data/" + CurrentRoleName + "/"), HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/elanat_system_data/role_data/" + dur.RoleName + "/"));
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.AdminPath + "/role/action/SuccessMessage.aspx");
        }
