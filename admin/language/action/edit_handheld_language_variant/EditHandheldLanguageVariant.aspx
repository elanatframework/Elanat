<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditHandheldLanguageVariant.aspx.cs" Inherits="elanat.ActionEditHandheldLanguageVariant" %><!DOCTYPE html>
...
<body onload="el_ListBoxAutoSizeByListBoxId('lstx_HandheldLanguageVariant'); el_PartPageLoad();">
    <form id="frm_ActionEditHandheldLanguageVariant" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/language/action/edit_handheld_language_variant/EditHandheldLanguageVariant.aspx" >
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveHandheldLanguageVariant" name="btn_SaveHandheldLanguageVariant" type="submit" class="el_button_input" value="<%=model.SaveHandheldLanguageVariantLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionEditHandheldLanguageVariant')" />
            </div>
        </div>
