<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditLanguageVariant.aspx.cs" Inherits="elanat.ActionEditLanguageVariant" %><!DOCTYPE html>
...
<body onload="el_ListBoxAutoSizeByListBoxId('lstx_LanguageVariant'); el_PartPageLoad();">
    <form id="frm_ActionEditLanguageVariant" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/language/action/edit_language_variant/EditLanguageVariant.aspx" >
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveLanguageVariant" name="btn_SaveLanguageVariant" type="submit" class="el_button_input" value="<%=model.SaveLanguageVariantLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionEditLanguageVariant')" />
            </div>
        </div>
