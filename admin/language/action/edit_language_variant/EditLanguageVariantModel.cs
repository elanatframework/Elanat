...
namespace elanat
{
    public class ActionEditLanguageVariantModel
    {
        ...
        public void SaveLanguageEvaluateField(NameValueCollection FormData)
        {
            ...
            if (!vc.TrueContinue)
            {
                ...
                //LanguageVariantCssClass = LanguageVariantCssClass.AddHtmlClass(vc.WarningFieldClass["lstx_LanguageVariant"]);
            }
        }

        public void DeleteLanguageVariantEvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
            vc.EvaluateField(FormData, StaticObject.GetCurrentAdminGlobalLanguage(), true, "edit_language_variant", StaticObject.AdminPath + "/language/");
        ...
        public void SaveLanguageVariant()
        {
            ...
            {
                string LanguageValue = HttpContext.Current.Request.Form["txt_Language_Edit_" + LanguageGlobalName];
