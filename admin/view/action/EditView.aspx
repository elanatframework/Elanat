<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditView.aspx.cs" Inherits="elanat.ActionEditView" validateRequest="false" %><!DOCTYPE html>
...
<body onload="el_PartPageLoad();">
    <form id="frm_ActionEditView" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/view/action/EditView.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveView" name="btn_SaveView" type="submit" class="el_button_input" value="<%=model.SaveViewLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionEditView')" />
            </div>
        </div>
