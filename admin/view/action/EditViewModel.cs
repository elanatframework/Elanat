...
namespace elanat
{
    public class ActionEditViewModel
    {
        ...
        public void SetValue()
        {
            ...
            lc.FillViewMatchTypeListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            ViewMatchTypeOptionListValue += lc.ViewMatchTypeListItem.HtmlInputToOptionTag(ViewMatchTypeOptionListSelectedValue);

            // Set Site Style Item
            lc.FillSiteStyleListItem();
            ViewSiteStyleOptionListValue += ViewSiteStyleOptionListValue.HtmlInputAddOptionTag("", "0");
            ViewSiteStyleOptionListValue += lc.SiteStyleListItem.HtmlInputToOptionTag(ViewSiteStyleOptionListSelectedValue);
            ...
            ViewSiteTemplateOptionListValue += lc.SiteTemplateListItem.HtmlInputToOptionTag(ViewSiteTemplateOptionListSelectedValue);

            // Set View Query String Value
            lc.FillViewQueryStringListItem(ViewIdValue);
            foreach (ListItem item in lc.ViewQueryStringListItem)
                ViewQueryStringValue += item.Text + "&";
            if (lc.ViewQueryStringListItem.Length > 0)
        ...
        public void SetImportantField()
        {
            ...
            ViewNameAttribute += vc.ImportantInputAttribute["txt_ViewName"];
            ViewQueryStringAttribute += vc.ImportantInputAttribute["txt_ViewQueryString"];
            ViewBackgroundColorAttribute += vc.ImportantInputAttribute["txt_ViewBackgroundColor"];
            ViewFontSizeAttribute += vc.ImportantInputAttribute["txt_ViewFontSize"];
            ViewCommonLightTextColorAttribute += vc.ImportantInputAttribute["txt_ViewCommonLightTextColor"];
            ViewCommonMiddleTextColorAttribute += vc.ImportantInputAttribute["txt_ViewCommonMiddleTextColor"];
            ViewCommonDarkTextColorAttribute += vc.ImportantInputAttribute["txt_ViewCommonDarkTextColor"];
            ViewNaturalLightTextColorAttribute += vc.ImportantInputAttribute["txt_ViewNaturalLightTextColor"];
            ViewNaturalMiddleTextColorAttribute += vc.ImportantInputAttribute["txt_ViewNaturalMiddleTextColor"];
            ViewNaturalDarkTextColorAttribute += vc.ImportantInputAttribute["txt_ViewNaturalDarkTextColor"];
            ViewCommonLightBackgroundColorAttribute += vc.ImportantInputAttribute["txt_ViewCommonLightBackgroundColor"];
            ViewCommonMiddleBackgroundColorAttribute += vc.ImportantInputAttribute["txt_ViewCommonMiddleBackgroundColor"];
            ViewCommonDarkBackgroundColorAttribute += vc.ImportantInputAttribute["txt_ViewCommonDarkBackgroundColor"];
            ViewNaturalLightBackgroundColorAttribute += vc.ImportantInputAttribute["txt_ViewNaturalLightBackgroundColor"];
            ViewNaturalMiddleBackgroundColorAttribute += vc.ImportantInputAttribute["txt_ViewNaturalMiddleBackgroundColor"];
            ViewNaturalDarkBackgroundColorAttribute += vc.ImportantInputAttribute["txt_ViewNaturalDarkBackgroundColor"];
            ViewStaticHeadAttribute += vc.ImportantInputAttribute["txt_ViewStaticHead"];
            ViewMatchTypeAttribute += vc.ImportantInputAttribute["ddlst_ViewMatchType"];
            ViewSiteStyleAttribute += vc.ImportantInputAttribute["ddlst_ViewSiteStyle"];
            ViewSiteTemplateAttribute += vc.ImportantInputAttribute["ddlst_ViewSiteTemplate"];

            ViewNameCssClass = ViewNameCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewName"]);
            ViewQueryStringCssClass = ViewQueryStringCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewQueryString"]);
            ViewBackgroundColorCssClass = ViewBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewBackgroundColor"]);
            ViewFontSizeCssClass = ViewFontSizeCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewFontSize"]);
            ViewCommonLightTextColorCssClass = ViewCommonLightTextColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewCommonLightTextColor"]);
            ViewCommonMiddleTextColorCssClass = ViewCommonMiddleTextColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewCommonMiddleTextColor"]);
            ViewCommonDarkTextColorCssClass = ViewCommonDarkTextColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewCommonDarkTextColor"]);
            ViewNaturalLightTextColorCssClass = ViewNaturalLightTextColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewNaturalLightTextColor"]);
            ViewNaturalMiddleTextColorCssClass = ViewNaturalMiddleTextColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewNaturalMiddleTextColor"]);
            ViewNaturalDarkTextColorCssClass = ViewNaturalDarkTextColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewNaturalDarkTextColor"]);
            ViewCommonLightBackgroundColorCssClass = ViewCommonLightBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewCommonLightBackgroundColor"]);
            ViewCommonMiddleBackgroundColorCssClass = ViewCommonMiddleBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewCommonMiddleBackgroundColor"]);
            ViewCommonDarkBackgroundColorCssClass = ViewCommonDarkBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewCommonDarkBackgroundColor"]);
            ViewNaturalLightBackgroundColorCssClass = ViewNaturalLightBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewNaturalLightBackgroundColor"]);
            ViewNaturalMiddleBackgroundColorCssClass = ViewNaturalMiddleBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewNaturalMiddleBackgroundColor"]);
            ViewNaturalDarkBackgroundColorCssClass = ViewNaturalDarkBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewNaturalDarkBackgroundColor"]);
            ViewStaticHeadCssClass = ViewStaticHeadCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ViewStaticHead"]);
            ViewMatchTypeCssClass = ViewMatchTypeCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_ViewMatchType"]);
            ViewSiteStyleCssClass = ViewSiteStyleCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_ViewSiteStyle"]);
            ViewSiteTemplateCssClass = ViewSiteTemplateCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_ViewSiteTemplate"]);
        }
        ...
        public void EvaluateField(NameValueCollection FormData)
        {
            ...
            if (!vc.TrueContinue)
            {
                ...
                //ViewNameCssClass = ViewNameCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewName"]);
                //ViewQueryStringCssClass = ViewQueryStringCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewQueryString"]);
                //ViewBackgroundColorCssClass = ViewBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewBackgroundColor"]);
                //ViewFontSizeCssClass = ViewFontSizeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewFontSize"]);
                //ViewCommonLightTextColorCssClass = ViewCommonLightTextColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewCommonLightTextColor"]);
                //ViewCommonMiddleTextColorCssClass = ViewCommonMiddleTextColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewCommonMiddleTextColor"]);
                //ViewCommonDarkTextColorCssClass = ViewCommonDarkTextColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewCommonDarkTextColor"]);
                //ViewNaturalLightTextColorCssClass = ViewNaturalLightTextColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewNaturalLightTextColor"]);
                //ViewNaturalMiddleTextColorCssClass = ViewNaturalMiddleTextColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewNaturalMiddleTextColor"]);
                //ViewNaturalDarkTextColorCssClass = ViewNaturalDarkTextColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewNaturalDarkTextColor"]);
                //ViewCommonLightBackgroundColorCssClass = ViewCommonLightBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewCommonLightBackgroundColor"]);
                //ViewCommonMiddleBackgroundColorCssClass = ViewCommonMiddleBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewCommonMiddleBackgroundColor"]);
                //ViewCommonDarkBackgroundColorCssClass = ViewCommonDarkBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewCommonDarkBackgroundColor"]);
                //ViewNaturalLightBackgroundColorCssClass = ViewNaturalLightBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewNaturalLightBackgroundColor"]);
                //ViewNaturalMiddleBackgroundColorCssClass = ViewNaturalMiddleBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewNaturalMiddleBackgroundColor"]);
                //ViewNaturalDarkBackgroundColorCssClass = ViewNaturalDarkBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewNaturalDarkBackgroundColor"]);
                //ViewStaticHeadCssClass = ViewStaticHeadCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ViewStaticHead"]);
                //ViewMatchTypeCssClass = ViewMatchTypeCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_ViewMatchType"]);
                //ViewSiteStyleCssClass = ViewSiteStyleCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_ViewSiteStyle"]);
                //ViewSiteTemplateCssClass = ViewSiteTemplateCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_ViewSiteTemplate"]);
            }
        }
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.AdminPath + "/view/action/SuccessMessage.aspx");
        }
