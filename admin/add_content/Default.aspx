<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="elanat.AdminAddContent" validateRequest="false" enableEventValidation="false" %><!DOCTYPE html>
    ...
    <form id="frm_AdminAddContent" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/add_content/Default.aspx">
        ...
        <div class="el_add_content">
            <div class="el_part_row">
                ...
                <div class="el_item">
                    <input id="btn_AddContent" name="btn_AddContent" type="submit" class="el_button_input<%=model.AddContentCssClass%>" value="<%=model.AddContentLanguage%>" onclick="el_TinyMceIssues(); el_AjaxPostBack(this, false, 'frm_AdminAddContent')" />
                    <input id="btn_SaveContent" name="btn_SaveContent" type="submit" class="el_button_input<%=model.SaveContentCssClass%>" value="<%=model.SaveContentLanguage%>" onclick="el_TinyMceIssues(); el_AjaxPostBack(this, false, 'frm_AdminAddContent')" />
                    <input id="btn_DraftContent" name="btn_DraftContent" type="submit" class="el_button_input<%=model.DraftContentCssClass%>" value="<%=model.DraftContentLanguage%>" onclick="el_TinyMceIssues(); el_AjaxPostBack(this, false, 'frm_AdminAddContent')" />
