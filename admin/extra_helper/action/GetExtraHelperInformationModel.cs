...
namespace elanat
{
    public class ActionGetExtraHelperInformationModel
    {
        public string GetInformation(string ExtraHelperDirectoryPath)
        {
            XmlDocument doc = new XmlDocument();
            doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/extra_helper/" + ExtraHelperDirectoryPath + "/catalog.xml"));
