<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="elanat.AdminLink" %><!DOCTYPE html>
            ...
            <div class="el_part_row">
                ...
                <div class="el_item">
                    <span class="el_checkbox_input">
                        <input id="cbx_LinkActive" name="cbx_LinkActive" type="checkbox" <%=elanat.AspxHtmlValue.BooleanToCheckedHtmlAttribute(model.LinkActiveValue)%> /><label for="cbx_LinkActive"><%=model.LinkActiveLanguage%></label></span>
                </div>
                <div class="el_item">
