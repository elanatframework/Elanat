<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditContact.aspx.cs" Inherits="elanat.ActionEditContact" %><!DOCTYPE html>
...
<body onload="el_PartPageLoad();">
    <form id="frm_ActionEditContact" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/contact/action/EditContact.aspx" enctype="multipart/form-data">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveContact" name="btn_SaveContact" type="submit" class="el_button_input" value="<%=model.SaveContactLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionEditContact')" />
            </div>
        </div>
