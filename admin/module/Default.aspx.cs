...
namespace elanat
{
    public partial class AdminModule : System.Web.UI.Page
    {
        ...
        {
            if (!string.IsNullOrEmpty(Request.Form["btn_AddModule"]))
                btn_AddModule_Click(sender, e);
        ...
        {
            model.ModulePathUploadValue = Request.Files["upd_ModulePath"];
            model.UseModulePathValue = Request.Form["cbx_UseModulePath"] == "on";
            model.ModulePathTextValue = Request.Form["txt_ModulePath"];
            model.PriorityForModuleValue = Request.Form["cbx_PriorityForModule"] == "on";
