...
namespace elanat
{
    public class ActionModuleNewRowModel
    {
        ...
        public void SetValue()
        {
            ...
            TmpRowBoxTemplate = TmpRowBoxTemplate.Replace("$_asp module_extension_name;", System.IO.Path.GetExtension(dum.ReturnDr["module_physical_name"].ToString()).Remove(0, 1));
