...
namespace elanat
{
    public class ActionChangeProfileModel
    {
        ...
        public void SetImportantField()
        {
            ...
            UserNameAttribute = UserNameAttribute.AddHtmlClass(vc.ImportantInputClass["txt_UserName"]);
            UserSiteNameAttribute = UserSiteNameAttribute.AddHtmlClass(vc.ImportantInputClass["txt_UserSiteName"]);
        ...
        public void EvaluateField(NameValueCollection FormData)
        {
            ...
            if (!vc.TrueContinue)
            {
                ...
                //UserNameAttribute = UserNameAttribute.AddHtmlClass(vc.WarningFieldClass["txt_UserName"]);
                //UserSiteNameAttribute = UserSiteNameAttribute.AddHtmlClass(vc.WarningFieldClass["txt_UserSiteName"]);
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.AdminPath + "/profile/action/change_profile/SuccessMessage.aspx", true);
        }
    }
}