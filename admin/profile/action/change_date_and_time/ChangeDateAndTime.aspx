<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeDateAndTime.aspx.cs" Inherits="elanat.ActionChangeDateAndTime" %><!DOCTYPE html>
...
<body onload="el_RunAction(); el_PartPageLoad();">
    ...
    <form id="frm_ActionChangeDateAndTime" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/profile/action/change_date_and_time/ChangeDateAndTime.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_ChangeDateAndTime" name="btn_ChangeDateAndTime" type="submit" class="el_button_input" value="<%=model.ChangeDateAndTimeLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionChangeDateAndTime')" />
            </div>
        </div>
