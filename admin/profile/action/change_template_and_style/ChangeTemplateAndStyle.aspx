<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeTemplateAndStyle.aspx.cs" Inherits="elanat.ActionChangeTemplateAndStyle" %><!DOCTYPE html>
...
<body onload="el_RunAction(); el_PartPageLoad();">
    ...
    <form id="frm_ActionChangeTemplateAndStyle" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/profile/action/change_template_and_style/ChangeTemplateAndStyle.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_ChangeTemplateAndStyle" name="btn_ChangeTemplateAndStyle" type="submit" class="el_button_input" value="<%=model.ChangeTemplateAndStyleLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionChangeTemplateAndStyle')" />
            </div>
        </div>
