...
namespace elanat
{
    public class ActionChangeTemplateAndStyleModel
    {
        ...
        public void SetValue()
        {
            ...
            SiteStyleOptionListValue += lc.SiteStyleListItem.HtmlInputToOptionTag(UserSiteStyleId);
            ...
            SiteTemplateOptionListValue += lc.SiteTemplateListItem.HtmlInputToOptionTag(UserSiteTemplateId);


            // Set Admin Style Item
            lc.FillAdminStyleListItem();
            AdminStyleOptionListValue += AdminStyleOptionListValue.HtmlInputAddOptionTag("", "0");
            AdminStyleOptionListValue += lc.AdminStyleListItem.HtmlInputToOptionTag(UserAdminStyleId);
            ...
            AdminTemplateOptionListValue += lc.AdminTemplateListItem.HtmlInputToOptionTag(UserAdminTemplateId);
        }
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.AdminPath + "/profile/action/change_template_and_style/action/SuccessMessage.aspx", true);
        }
    }
}