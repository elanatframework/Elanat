<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeView.aspx.cs" Inherits="elanat.ActionChangeView" %><!DOCTYPE html>
...
<body onload="el_RunAction(); el_PartPageLoad();">
    ...
    <form id="frm_ActionChangeView" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/profile/action/change_view/ChangeView.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_ChangeView" name="btn_ChangeView" type="submit" class="el_button_input" value="<%=model.ChangeViewLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionChangeView')" />
            </div>
        </div>
