...
namespace elanat
{
    public class ActionChangeViewModel
    {
        ...
        public void SetImportantField()
        {
            ...
            vc.SetImportantField(InputRequest, true, StaticObject.AdminPath + "/profile/", "change_view");

            UserBackgroundColorAttribute += vc.ImportantInputAttribute["txt_UserBackgroundColor"];
            UserFontSizeAttribute += vc.ImportantInputAttribute["txt_UserFontSize"];
            UserCommonLightBackgroundColorAttribute += vc.ImportantInputAttribute["txt_UserCommonLightBackgroundColor"];
            UserCommonLightTextColorAttribute += vc.ImportantInputAttribute["txt_UserCommonLightTextColor"];
            UserCommonMiddleBackgroundColorAttribute += vc.ImportantInputAttribute["txt_UserCommonMiddleBackgroundColor"];
            UserCommonMiddleTextColorAttribute += vc.ImportantInputAttribute["txt_UserCommonMiddleTextColor"];
            UserCommonDarkBackgroundColorAttribute += vc.ImportantInputAttribute["txt_UserCommonDarkBackgroundColor"];
            UserCommonDarkTextColorAttribute += vc.ImportantInputAttribute["txt_UserCommonDarkTextColor"];
            UserNaturalLightBackgroundColorAttribute += vc.ImportantInputAttribute["txt_UserNaturalLightBackgroundColor"];
            UserNaturalLightTextColorAttribute += vc.ImportantInputAttribute["txt_UserNaturalLightTextColor"];
            UserNaturalMiddleBackgroundColorAttribute += vc.ImportantInputAttribute["txt_UserNaturalMiddleBackgroundColor"];
            UserNaturalMiddleTextColorAttribute += vc.ImportantInputAttribute["txt_UserNaturalMiddleTextColor"];
            UserNaturalDarkBackgroundColorAttribute += vc.ImportantInputAttribute["txt_UserNaturalDarkBackgroundColor"];
            UserNaturalDarkTextColorAttribute += vc.ImportantInputAttribute["txt_UserNaturalDarkTextColor"];
            UserInfoBackgroundColorAttribute += vc.ImportantInputAttribute["txt_UserInfoBackgroundColor"];
            UserInfoFontColorAttribute += vc.ImportantInputAttribute["txt_UserInfoFontColor"];

            UserBackgroundColorCssClass = UserBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserBackgroundColor"]);
            UserFontSizeCssClass = UserFontSizeCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserFontSize"]);
            UserCommonLightBackgroundColorCssClass = UserCommonLightBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserCommonLightBackgroundColor"]);
            UserCommonLightTextColorCssClass = UserCommonLightTextColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserCommonLightTextColor"]);
            UserCommonMiddleBackgroundColorCssClass = UserCommonMiddleBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserCommonMiddleBackgroundColor"]);
            UserCommonMiddleTextColorCssClass = UserCommonMiddleTextColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserCommonMiddleTextColor"]);
            UserCommonDarkBackgroundColorCssClass = UserCommonDarkBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserCommonDarkBackgroundColor"]);
            UserCommonDarkTextColorCssClass = UserCommonDarkTextColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserCommonDarkTextColor"]);
            UserNaturalLightBackgroundColorCssClass = UserNaturalLightBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserNaturalLightBackgroundColor"]);
            UserNaturalLightTextColorCssClass = UserNaturalLightTextColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserNaturalLightTextColor"]);
            UserNaturalMiddleBackgroundColorCssClass = UserNaturalMiddleBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserNaturalMiddleBackgroundColor"]);
            UserNaturalMiddleTextColorCssClass = UserNaturalMiddleTextColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserNaturalMiddleTextColor"]);
            UserNaturalDarkBackgroundColorCssClass = UserNaturalDarkBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserNaturalDarkBackgroundColor"]);
            UserNaturalDarkTextColorCssClass = UserNaturalDarkTextColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserNaturalDarkTextColor"]);
            UserInfoBackgroundColorCssClass = UserInfoBackgroundColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserInfoBackgroundColor"]);
            UserInfoFontColorCssClass = UserInfoFontColorCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserInfoFontColor"]);
        }

        public void EvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
            vc.EvaluateField(FormData, StaticObject.GetCurrentAdminGlobalLanguage(), true, "change_view", StaticObject.AdminPath + "/profile/");
            ...
            if (!vc.TrueContinue)
            {
                ...
                //UserBackgroundColorCssClass = UserBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserBackgroundColor"]);
                //UserFontSizeCssClass = UserFontSizeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserFontSize"]);
                //UserCommonLightBackgroundColorCssClass = UserCommonLightBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserCommonLightBackgroundColor"]);
                //UserCommonLightTextColorCssClass = UserCommonLightTextColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserCommonLightTextColor"]);
                //UserCommonMiddleBackgroundColorCssClass = UserCommonMiddleBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserCommonMiddleBackgroundColor"]);
                //UserCommonMiddleTextColorCssClass = UserCommonMiddleTextColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserCommonMiddleTextColor"]);
                //UserCommonDarkBackgroundColorCssClass = UserCommonDarkBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserCommonDarkBackgroundColor"]);
                //UserCommonDarkTextColorCssClass = UserCommonDarkTextColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserCommonDarkTextColor"]);
                //UserNaturalLightBackgroundColorCssClass = UserNaturalLightBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserNaturalLightBackgroundColor"]);
                //UserNaturalLightTextColorCssClass = UserNaturalLightTextColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserNaturalLightTextColor"]);
                //UserNaturalMiddleBackgroundColorCssClass = UserNaturalMiddleBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserNaturalMiddleBackgroundColor"]);
                //UserNaturalMiddleTextColorCssClass = UserNaturalMiddleTextColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserNaturalMiddleTextColor"]);
                //UserNaturalDarkBackgroundColorCssClass = UserNaturalDarkBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserNaturalDarkBackgroundColor"]);
                //UserNaturalDarkTextColorCssClass = UserNaturalDarkTextColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserNaturalDarkTextColor"]);
                //UserInfoBackgroundColorCssClass = UserInfoBackgroundColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserInfoBackgroundColor"]);
                //UserInfoFontColorCssClass = UserInfoFontColorCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserInfoFontColor"]);
            }
        }
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.AdminPath + "/profile/action/change_view/action/SuccessMessage.aspx", true);
        }
    }
}