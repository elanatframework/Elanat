...
namespace elanat
{
    public class ActionGetSiteStyleInformationModel
    {
        public string GetInformation(string SiteStyleDirectoryPath)
        {
            XmlDocument doc = new XmlDocument();
            doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "client/style/site/" + SiteStyleDirectoryPath + "/catalog.xml"));
