...
namespace elanat
{
    public class ActionMenuNewRowModel
    {
        ...
        public void SetValue()
        {
            ...
            string RowBoxTemplate = doc.SelectSingleNode("template_root/table/menu/new_row/box").InnerTextAfterSetNodeVariant(StaticObject.GetCurrentAdminGlobalLanguage());
            string RowListItemTemplate = doc.SelectSingleNode("template_root/table/menu/new_row/list_item").InnerTextAfterSetNodeVariant(StaticObject.GetCurrentAdminGlobalLanguage());
            ...
            dum.FillCurrentMenuWithReturnDr(MenuIdValue);
            ...
            TmpRowBoxTemplate = TmpRowBoxTemplate.Replace("$_asp menu_id;", dum.ReturnDr["menu_id"].ToString());
            TmpRowBoxTemplate = (dum.ReturnDr["menu_active"].ToString().TrueFalseToBoolean()) ? TmpRowBoxTemplate.Replace("$_asp check_active_inactive;", "active").Replace("$_asp check_Active_Inactive;", "Inactive") : TmpRowBoxTemplate.Replace("$_asp check_active_inactive;", "inactive").Replace("$_asp check_Active_Inactive;", "Active");
