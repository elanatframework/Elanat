...
namespace elanat
{
    public class ActionGetMenuViewMoreModel
    {
        public string GetViewMore(string MenuId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/menu/");
