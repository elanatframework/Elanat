...
namespace elanat
{
    public class ActionEditSiteModel
    {
        ...
        public void SetValue()
        {
            ...
            lc.FillSiteAccessShowListItem(SiteIdValue);
            SiteAccessShowTemplateValue = SiteAccessShowTemplateValue.HtmlInputSetCheckBoxListValue(lc.SiteAccessShowListItem);
        }
        ...
        public void SetImportantField()
        {
            ...
            SiteDateCreateAttribute += vc.ImportantInputAttribute["txt_SiteDateCreate"];
            SiteTimeCreateAttribute += vc.ImportantInputAttribute["txt_SiteTimeCreate"];
            SiteVisitAttribute += vc.ImportantInputAttribute["txt_SiteVisit"];
            ...
            SiteDateCreateCssClass = SiteDateCreateCssClass.AddHtmlClass(vc.ImportantInputClass["txt_SiteDateCreate"]);
            SiteTimeCreateCssClass = SiteTimeCreateCssClass.AddHtmlClass(vc.ImportantInputClass["txt_SiteTimeCreate"]);
            SiteVisitCssClass = SiteVisitCssClass.AddHtmlClass(vc.ImportantInputClass["txt_SiteVisit"]);
        ...
        public void EvaluateField(NameValueCollection FormData)
        {
            ...
            if (!vc.TrueContinue)
            {
                ...
                //SiteDateCreateCssClass = SiteDateCreateCssClass.AddHtmlClass(vc.WarningFieldClass["txt_SiteDateCreate"]);
                //SiteTimeCreateCssClass = SiteTimeCreateCssClass.AddHtmlClass(vc.WarningFieldClass["txt_SiteTimeCreate"]);
                //SiteVisitCssClass = SiteVisitCssClass.AddHtmlClass(vc.WarningFieldClass["txt_SiteVisit"]);
        ...
        public void SaveSite(object sender, EventArgs e)
        {
            ...
            if (CurrentSiteGlobalName != dus.SiteGlobalName)
                System.IO.Directory.Move(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/elanat_system_data/site_data/" + CurrentSiteGlobalName + "/"), HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/elanat_system_data/site_data/" + dus.SiteGlobalName + "/"));
            ...
            if (CurrentSiteGlobalName == "default")
            {
                ...
                System.IO.File.Move(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "client/image/site_logo/" + CurrentSiteGlobalName + ".png"), HttpContext.Current.Server.MapPath(StaticObject.SitePath + "client/image/site_logo/" + dus.SiteGlobalName + ".png"));
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.AdminPath + "/site/action/SuccessMessage.aspx");
        }
