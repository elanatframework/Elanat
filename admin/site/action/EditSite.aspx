<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditSite.aspx.cs" Inherits="elanat.ActionEditSite" validateRequest="false" %><!DOCTYPE html>
...
<body onload="el_PartPageLoad();">
    <form id="frm_ActionEditSite" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/site/action/EditSite.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveSite" name="btn_SaveSite" type="submit" class="el_button_input" value="<%=model.SaveSiteLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionEditSite')" />
            </div>
        </div>
