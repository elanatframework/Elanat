...
namespace elanat
{
    public class ActionChangeFilePermissionsModel
    {
        ...
        public void SetValue()
        {
            ...
            permissions.FillFilePermissions(HttpContext.Current.Server.MapPath(StaticObject.SitePath + FilePathValue));
        ...
        public void SaveFilePermissions()
        {
            ...
            FilePermissions permissions = new FilePermissions();
            permissions.SetFilePermissions(HttpContext.Current.Server.MapPath(StaticObject.SitePath + FilePathValue), FullControl, Read, Write, AppendData, ChangePermissions, Delete, ExecuteFile, Modify, ReadAndExecute, ReadAttributes, ReadData, ReadExtendedAttributes, ReadPermissions, TakeOwnership, WriteAttributes, WriteData, WriteExtendedAttributes);
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.AdminPath + "/file_manager/action/change_file_permissions/action/SuccessMessage.aspx", true);
        }
    }
}