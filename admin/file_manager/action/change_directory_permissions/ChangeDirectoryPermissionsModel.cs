...
namespace elanat
{
    public class ActionChangeDirectoryPermissionsModel
    {
        ...
        public void SetValue()
        {
            ...
            permissions.FillDirectoryPermissions(HttpContext.Current.Server.MapPath(StaticObject.SitePath + DirectoryPathValue));
        ...
        public void SaveDirectoryPermissions()
        {
            ...
            DirectoryPermissions permissions = new DirectoryPermissions();
            permissions.SetDirectoryPermissions(HttpContext.Current.Server.MapPath(StaticObject.SitePath + DirectoryPathValue), FullControl, Read, Write, ChangePermissions, CreateDirectories, CreateFiles, Delete, DeleteSubdirectoriesAndFiles, ListDirectory, Modify, ReadAttributes, ReadExtendedAttributes, ReadPermissions, TakeOwnership, Traverse, WriteAttributes, WriteExtendedAttributes);
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.AdminPath + "/file_manager/action/change_directory_permissions/action/SuccessMessage.aspx", true);
        }
    }
}