...
namespace elanat
{
    public class AdminFileManagerModel
    {
        ...
        public void SetValue(NameValueCollection QueryString)
        {
            ...
            if (string.IsNullOrEmpty(PathHiddenValue))
                RootPath = (string.IsNullOrEmpty(QueryString["directory"])) ? fad.GetRootPath(HttpContext.Current.Server.MapPath("/")) : fad.GetRootPath(HttpContext.Current.Server.MapPath("/" + QueryString["directory"].ToString()));
            else
        ...
        public void CreateFileEvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
        ...
        public void CreateDirectoryEvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
        ...
        {
            string Path = HttpContext.Current.Server.MapPath(StaticObject.SitePath + PathHiddenValue);
