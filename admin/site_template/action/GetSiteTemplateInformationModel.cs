...
namespace elanat
{
    public class ActionGetSiteTemplateInformationModel
    {
        public string GetInformation(string SiteTemplateDirectoryPath)
        {
            XmlDocument doc = new XmlDocument();
            doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "template/site/" + SiteTemplateDirectoryPath + "/catalog.xml"));
