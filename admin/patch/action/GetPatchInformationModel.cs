...
namespace elanat
{
    public class ActionGetPatchInformationModel
    {
        public string GetInformation(string PatchDirectoryPath)
        {
            XmlDocument doc = new XmlDocument();
            doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/patch/" + PatchDirectoryPath + "/catalog.xml"));
