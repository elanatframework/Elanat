...
namespace elanat
{
    public class ActionEditUserModel
    {
        ...
        public void SetImportantField()
        {
            ...
            UserDateCreateAttribute += vc.ImportantInputAttribute["txt_UserDateCreate"];
            ...
            UserDateCreateCssClass = UserDateCreateCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserDateCreate"]);
        ...
        public void EvaluateField(NameValueCollection FormData)
        {
            ...
            if (!vc.TrueContinue)
            {
                ...
                //UserDateCreateCssClass = UserDateCreateCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserDateCreate"]);
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.AdminPath + "/user/action/SuccessMessage.aspx");
        }
    }
}