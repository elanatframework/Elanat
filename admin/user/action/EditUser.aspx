<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="elanat.ActionEditUser" %><!DOCTYPE html>
...
<body onload="el_PartPageLoad();">
    <form id="frm_ActionEditUser" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/user/action/EditUser.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveUser" name="btn_SaveUser" type="submit" class="el_button_input" value="<%=model.SaveUserLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionEditUser')" />
            </div>
        </div>
