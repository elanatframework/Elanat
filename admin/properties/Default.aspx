<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="elanat.AdminProperties" %><!DOCTYPE html>
...
<body onload="el_RunAction(); el_PartPageLoad();">
    ...
    <form id="frm_AdminProperties" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/properties/Default.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveProperties" name="btn_SaveProperties" type="submit" class="el_button_input" value="<%=model.SavePropertiesLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_AdminProperties')" />
            </div>
        </div>
    ...
    <form id="frm_AdminView" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/properties/Default.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveView" name="btn_SaveView" type="submit" class="el_button_input" value="<%=model.SaveViewLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_AdminView')" />
            </div>
        </div>
    ...
    <form id="frm_AdminInclude" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/properties/Default.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveInclude" name="btn_SaveInclude" type="submit" class="el_button_input" value="<%=model.SaveIncludeLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_AdminInclude')" />
            </div>
        </div>
