...
namespace elanat
{
    public class AdminPropertiesModel
    {
        ...
        public void SetValue()
        {
            ...
            lc.FillReadMoreStatusListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            ReadMoreStatusOptionListValue += lc.ReadMoreStatusListItem.HtmlInputToOptionTag(ReadMoreStatusOptionListSelectedValue);

            // Set System Item
            lc.FillSystemListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            DefaultSystemOptionListValue += lc.SystemListItem.HtmlInputToOptionTag(DefaultSystemOptionListSelectedValue);

            // Set Component Item
            lc.FillComponentNameListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            DefaultComponentOptionListValue += lc.ComponentNameListItem.HtmlInputToOptionTag(DefaultComponentOptionListSelectedValue);

            // Set Site Item
            lc.FillSiteNameListItem();
            DefaultSiteOptionListValue += lc.SiteNameListItem.HtmlInputToOptionTag(DefaultSiteOptionListSelectedValue);

            // Set Page Item
            lc.FillPageNameListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            DefaultPageOptionListValue += lc.PageNameListItem.HtmlInputToOptionTag(DefaultPageOptionListSelectedValue);

            // Set Admin Language Item
            lc.FillLanguageNameListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            DefaultAdminLanguageOptionListValue += lc.LanguageNameListItem.HtmlInputToOptionTag(DefaultAdminLanguageOptionListSelectedValue);

            // Set Site Language Item
            DefaultSiteLanguageOptionListValue += lc.LanguageNameListItem.HtmlInputToOptionTag(DefaultSiteLanguageOptionListSelectedValue);

            // Set Site Style Name Item
            lc.FillSiteStyleNameListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            DefaultSiteStyleOptionListValue += lc.SiteStyleNameListItem.HtmlInputToOptionTag(DefaultSiteStyleOptionListSelectedValue);

            // Set Site Template Name Item
            lc.FillSiteTemplateNameListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            DefaultSiteTemplateOptionListValue += lc.SiteTemplateNameListItem.HtmlInputToOptionTag(DefaultSiteTemplateOptionListSelectedValue);

            // Set Admin Style Name Item
            lc.FillAdminStyleNameListItem();
            DefaultAdminStyleOptionListValue += lc.AdminStyleNameListItem.HtmlInputToOptionTag(DefaultAdminStyleOptionListSelectedValue);

            // Set Admin Template Name Item
            lc.FillAdminTemplateNameListItem();
            DefaultAdminTemplateOptionListValue += lc.AdminTemplateNameListItem.HtmlInputToOptionTag(DefaultAdminTemplateOptionListSelectedValue);

            // Set Content Page Number Location Item
            lc.FillContentPageNumberLocationListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            ContentPageNumberLocationOptionListValue += lc.ContentPageNumberLocationListItem.HtmlInputToOptionTag(ContentPageNumberLocationOptionListSelectedValue);

            // Set Dynamic Server Page Load Type Item
            lc.FillDynamicServerPageLoadTypeListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            AddContentReplyLoadTypeInMainPageOptionListValue += lc.DynamicServerPageLoadTypeListItem.HtmlInputToOptionTag(AddContentReplyLoadTypeInMainPageOptionListSelectedValue);
            AddCommentLoadTypeInMainPageOptionListValue += lc.DynamicServerPageLoadTypeListItem.HtmlInputToOptionTag(AddCommentLoadTypeInMainPageOptionListSelectedValue);
            AddContentReplyLoadTypeInContentPageOptionListValue += lc.DynamicServerPageLoadTypeListItem.HtmlInputToOptionTag(AddContentReplyLoadTypeInContentPageOptionListSelectedValue);
            AddCommentLoadTypeInContentPageOptionListValue += lc.DynamicServerPageLoadTypeListItem.HtmlInputToOptionTag(AddCommentLoadTypeInContentPageOptionListSelectedValue);

            // Set Include Box Item
            lc.FillIncludeBoxListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            IncludeBoxOptionListValue += lc.IncludeBoxListItem.HtmlInputToOptionTag(IncludeBoxOptionListSelectedValue);

            // Set Include Captcha Item
            lc.FillIncludeCaptchaListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            IncludeCaptchaOptionListValue += lc.IncludeCaptchaListItem.HtmlInputToOptionTag(IncludeCaptchaOptionListSelectedValue);

            // Set Include Calendar Item
            lc.FillIncludeCalendarListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            IncludeCalendarOptionListValue += lc.IncludeCalendarListItem.HtmlInputToOptionTag(IncludeCalendarOptionListSelectedValue);

            // Set Include File Viewer Item
            lc.FillIncludeFileViewerListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            IncludeFileViewerOptionListValue += lc.IncludeFileViewerListItem.HtmlInputToOptionTag(IncludeFileViewerOptionListSelectedValue);

            // Set Include Wysiwyg Item
            lc.FillIncludeWysiwygListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            IncludeWysiwygOptionListValue += lc.IncludeWysiwygListItem.HtmlInputToOptionTag(IncludeWysiwygOptionListSelectedValue);

            // Set Before After Location Item
            lc.FillBeforeAfterLocationListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            CommentInAddCommentBoxLocationOptionListValue += lc.BeforeAfterLocationListItem.HtmlInputToOptionTag(CommentInAddCommentBoxLocationOptionListSelectedValue);
        }
        ...
        public void SetImportantField()
        {
            ...
            ContentInMainPageAttribute += vc.ImportantInputAttribute["txt_ContentInMainPage"];
            ContentPerPageAttribute += vc.ImportantInputAttribute["txt_ContentPerPage"];
            CommentInContentAttribute += vc.ImportantInputAttribute["txt_CommentInContent"];
            CommentReplyInCommentAttribute += vc.ImportantInputAttribute["txt_CommentReplyInComment"];
            RowInMainTableAttribute += vc.ImportantInputAttribute["txt_RowInMainTable"];
            RowPerTableAttribute += vc.ImportantInputAttribute["txt_RowPerTable"];
            ContentTextCharacterLengthAttribute += vc.ImportantInputAttribute["txt_ContentTextCharacterLength"];
            SitePathAttribute += vc.ImportantInputAttribute["txt_SitePath"];
            NullLanguageSuffixAttribute += vc.ImportantInputAttribute["txt_NullLanguageSuffix"];
            CornHourDurationAttribute += vc.ImportantInputAttribute["txt_CornHourDuration"];
            ReadMoreStatusAttribute += vc.ImportantInputAttribute["ddlst_ReadMoreStatus"];
            DefaultSiteAttribute += vc.ImportantInputAttribute["ddlst_DefaultSite"];
            DefaultPageAttribute += vc.ImportantInputAttribute["ddlst_DefaultPage"];
            DefaultSiteLanguageAttribute += vc.ImportantInputAttribute["ddlst_DefaultSiteLanguage"];
            DefaultAdminLanguageAttribute += vc.ImportantInputAttribute["ddlst_DefaultAdminLanguage"];
            DefaultSiteStyleAttribute += vc.ImportantInputAttribute["ddlst_DefaultSiteStyle"];
            DefaultSiteTemplateAttribute += vc.ImportantInputAttribute["ddlst_DefaultSiteTemplate"];
            DefaultAdminStyleAttribute += vc.ImportantInputAttribute["ddlst_DefaultAdminStyle"];
            DefaultAdminTemplateAttribute += vc.ImportantInputAttribute["ddlst_DefaultAdminTemplate"];
            DefaultSystemAttribute += vc.ImportantInputAttribute["ddlst_DefaultSystem"];
            DefaultComponentAttribute += vc.ImportantInputAttribute["ddlst_DefaultComponent"];
            ContentPageNumberLocationAttribute += vc.ImportantInputAttribute["ddlst_ContentPageNumberLocation"];
            CommentInAddCommentBoxLocationAttribute += vc.ImportantInputAttribute["ddlst_CommentInAddCommentBoxLocation"];
            AddCommentLoadTypeInMainPageAttribute += vc.ImportantInputAttribute["ddlst_AddCommentLoadTypeInMainPage"];
            AddContentReplyLoadTypeInMainPageAttribute += vc.ImportantInputAttribute["ddlst_AddContentReplyLoadTypeInMainPage"];
            AddCommentLoadTypeInContentPageAttribute += vc.ImportantInputAttribute["ddlst_AddCommentLoadTypeInContentPage"];
            AddContentReplyLoadTypeInContentPageAttribute += vc.ImportantInputAttribute["ddlst_AddContentReplyLoadTypeInContentPage"];
            IncludeBoxAttribute += vc.ImportantInputAttribute["ddlst_IncludeBox"];
            IncludeCaptchaAttribute += vc.ImportantInputAttribute["ddlst_IncludeCaptcha"];
            IncludeCalendarAttribute += vc.ImportantInputAttribute["ddlst_IncludeCalendar"];
            IncludeFileViewerAttribute += vc.ImportantInputAttribute["ddlst_IncludeFileViewer"];
            IncludeWysiwygAttribute += vc.ImportantInputAttribute["ddlst_IncludeWysiwyg"];

            ContentInMainPageCssClass = ContentInMainPageCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ContentInMainPage"]);
            ContentPerPageCssClass = ContentPerPageCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ContentPerPage"]);
            CommentInContentCssClass = CommentInContentCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CommentInContent"]);
            CommentReplyInCommentCssClass = CommentReplyInCommentCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CommentReplyInComment"]);
            RowInMainTableCssClass = RowInMainTableCssClass.AddHtmlClass(vc.ImportantInputClass["txt_RowInMainTable"]);
            RowPerTableCssClass = RowPerTableCssClass.AddHtmlClass(vc.ImportantInputClass["txt_RowPerTable"]);
            ContentTextCharacterLengthCssClass = ContentTextCharacterLengthCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ContentTextCharacterLength"]);
            SitePathCssClass = SitePathCssClass.AddHtmlClass(vc.ImportantInputClass["txt_SitePath"]);
            NullLanguageSuffixCssClass = NullLanguageSuffixCssClass.AddHtmlClass(vc.ImportantInputClass["txt_NullLanguageSuffix"]);
            CornHourDurationCssClass = CornHourDurationCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CornHourDuration"]);
            ReadMoreStatusCssClass = ReadMoreStatusCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_ReadMoreStatus"]);
            DefaultSiteCssClass = DefaultSiteCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_DefaultSite"]);
            DefaultPageCssClass = DefaultPageCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_DefaultPage"]);
            DefaultSiteLanguageCssClass = DefaultSiteLanguageCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_DefaultSiteLanguage"]);
            DefaultAdminLanguageCssClass = DefaultAdminLanguageCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_DefaultAdminLanguage"]);
            DefaultSiteStyleCssClass = DefaultSiteStyleCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_DefaultSiteStyle"]);
            DefaultSiteTemplateCssClass = DefaultSiteTemplateCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_DefaultSiteTemplate"]);
            DefaultAdminStyleCssClass = DefaultAdminStyleCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_DefaultAdminStyle"]);
            DefaultAdminTemplateCssClass = DefaultAdminTemplateCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_DefaultAdminTemplate"]);
            DefaultSystemCssClass = DefaultSystemCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_DefaultSystem"]);
            DefaultComponentCssClass = DefaultComponentCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_DefaultComponent"]);
            ContentPageNumberLocationCssClass = ContentPageNumberLocationCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_ContentPageNumberLocation"]);
            CommentInAddCommentBoxLocationCssClass = CommentInAddCommentBoxLocationCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_CommentInAddCommentBoxLocation"]);
            AddCommentLoadTypeInMainPageCssClass = AddCommentLoadTypeInMainPageCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_AddCommentLoadTypeInMainPage"]);
            AddContentReplyLoadTypeInMainPageCssClass = AddContentReplyLoadTypeInMainPageCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_AddContentReplyLoadTypeInMainPage"]);
            AddCommentLoadTypeInContentPageCssClass = AddCommentLoadTypeInContentPageCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_AddCommentLoadTypeInContentPage"]);
            AddContentReplyLoadTypeInContentPageCssClass = AddContentReplyLoadTypeInContentPageCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_AddContentReplyLoadTypeInContentPage"]);
            IncludeBoxCssClass = IncludeBoxCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_IncludeBox"]);
            IncludeCaptchaCssClass = IncludeCaptchaCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_IncludeCaptcha"]);
            IncludeCalendarCssClass = IncludeCalendarCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_IncludeCalendar"]);
            IncludeFileViewerCssClass = IncludeFileViewerCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_IncludeFileViewer"]);
            IncludeWysiwygCssClass = IncludeWysiwygCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_IncludeWysiwyg"]);
        }

        public void PropertiesEvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
            ...
            if (!vc.TrueContinue)
            {
                ...
                //ContentInMainPageCssClass = ContentInMainPageCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ContentInMainPage"]);
                //ContentPerPageCssClass = ContentPerPageCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ContentPerPage"]);
                //CommentInContentCssClass = CommentInContentCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CommentInContent"]);
                //CommentReplyInCommentCssClass = CommentReplyInCommentCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CommentReplyInComment"]);
                //RowInMainTableCssClass = RowInMainTableCssClass.AddHtmlClass(vc.WarningFieldClass["txt_RowInMainTable"]);
                //RowPerTableCssClass = RowPerTableCssClass.AddHtmlClass(vc.WarningFieldClass["txt_RowPerTable"]);
                //ContentTextCharacterLengthCssClass = ContentTextCharacterLengthCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ContentTextCharacterLength"]);
                //SitePathCssClass = SitePathCssClass.AddHtmlClass(vc.WarningFieldClass["txt_SitePath"]);
                //NullLanguageSuffixCssClass = NullLanguageSuffixCssClass.AddHtmlClass(vc.WarningFieldClass["txt_NullLanguageSuffix"]);
                //CornHourDurationCssClass = CornHourDurationCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CornHourDuration"]);
                //ReadMoreStatusCssClass = ReadMoreStatusCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_ReadMoreStatus"]);
                //DefaultSiteCssClass = DefaultSiteCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_DefaultSite"]);
                //DefaultPageCssClass = DefaultPageCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_DefaultPage"]);
                //DefaultSiteLanguageCssClass = DefaultSiteLanguageCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_DefaultSiteLanguage"]);
                //DefaultAdminLanguageCssClass = DefaultAdminLanguageCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_DefaultAdminLanguage"]);
                //DefaultSiteStyleCssClass = DefaultSiteStyleCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_DefaultSiteStyle"]);
                //DefaultSiteTemplateCssClass = DefaultSiteTemplateCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_DefaultSiteTemplate"]);
                //DefaultAdminStyleCssClass = DefaultAdminStyleCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_DefaultAdminStyle"]);
                //DefaultAdminTemplateCssClass = DefaultAdminTemplateCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_DefaultAdminTemplate"]);
                //DefaultSystemCssClass = DefaultSystemCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_DefaultSystem"]);
                //DefaultComponentCssClass = DefaultComponentCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_DefaultComponent"]);
                //ContentPageNumberLocationCssClass = ContentPageNumberLocationCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_ContentPageNumberLocation"]);
                //CommentInAddCommentBoxLocationCssClass = CommentInAddCommentBoxLocationCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_CommentInAddCommentBoxLocation"]);
            }
        }

        public void ViewEvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
            ...
            if (!vc.TrueContinue)
            {
                ...
                //AddCommentLoadTypeInMainPageCssClass = AddCommentLoadTypeInMainPageCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_AddCommentLoadTypeInMainPage"]);
                //AddContentReplyLoadTypeInMainPageCssClass = AddContentReplyLoadTypeInMainPageCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_AddContentReplyLoadTypeInMainPage"]);
                //AddCommentLoadTypeInContentPageCssClass = AddCommentLoadTypeInContentPageCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_AddCommentLoadTypeInContentPage"]);
                //AddContentReplyLoadTypeInContentPageCssClass = AddContentReplyLoadTypeInContentPageCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_AddContentReplyLoadTypeInContentPage"]);
            }
        }

        public void IncludeEvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
            ...
            if (!vc.TrueContinue)
            {
                ...
                //IncludeBoxCssClass = IncludeBoxCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_IncludeBox"]);
                //IncludeCaptchaCssClass = IncludeCaptchaCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_IncludeCaptcha"]);
                //IncludeCalendarCssClass = IncludeCalendarCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_IncludeCalendar"]);
                //IncludeFileViewerCssClass = IncludeFileViewerCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_IncludeFileViewer"]);
                //IncludeWysiwygCssClass = IncludeWysiwygCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_IncludeWysiwyg"]);
            }
        }
