...
namespace elanat
{
    public class ActionEditorTemplateNewRowModel
    {
        ...
        public void SetValue()
        {
            ...
            TmpRowBoxTemplate = TmpRowBoxTemplate.Replace("$_asp editor_template_extension_name;", System.IO.Path.GetExtension(duet.ReturnDr["editor_template_physical_path"].ToString()).Remove(0, 1));
