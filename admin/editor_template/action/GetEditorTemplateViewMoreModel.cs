...
namespace elanat
{
    public class ActionGetEditorTemplateViewMoreModel
    {
        public string GetViewMore(string EditorTemplateId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/editor_template/");
