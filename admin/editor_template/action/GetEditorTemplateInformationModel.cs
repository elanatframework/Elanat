...
namespace elanat
{
    public class ActionGetEditorTemplateInformationModel
    {
        public string GetInformation(string EditorTemplateDirectoryPath)
        {
            XmlDocument doc = new XmlDocument();
            doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/editor_template/" + EditorTemplateDirectoryPath + "/catalog.xml"));
