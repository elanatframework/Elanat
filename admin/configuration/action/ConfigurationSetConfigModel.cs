...
namespace elanat
{
    public class ActionConfigurationSetConfigModel
    {
        ...
        {
            SetConfigurationText(ConfigNameValue);
        }

        public void SetConfigurationText(string ConfigurationName)
        {
            ...
            string[] Lines = File.ReadAllLines(HttpContext.Current.Server.MapPath(ConfigurationPath));
            ...
            HttpContext.Current.Session.Add("el_current_configuration_path", ConfigurationPath);

            HttpContext.Current.Response.Write(ConfigValue);
        }
    }
}