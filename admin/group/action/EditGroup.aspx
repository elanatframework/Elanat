<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditGroup.aspx.cs" Inherits="elanat.ActionEditGroup" %><!DOCTYPE html>
...
<body onload="el_PartPageLoad();">
    <form id="frm_ActionEditGroup" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/group/action/EditGroup.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveGroup" name="btn_SaveGroup" type="submit" class="el_button_input" value="<%=model.SaveGroupLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionEditGroup')" />
            </div>
        </div>
