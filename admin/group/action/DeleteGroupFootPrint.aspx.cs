...
namespace elanat
{
    public partial class ActionDeleteGroupFootPrint : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            dug.DeleteFootPrint(Request.QueryString["group_id"].ToString());
            Response.Write("true");
				
				
			// Add Reference
			ReferenceClass rc = new ReferenceClass();
			rc.StartEvent("delete_group_foot_print", Request.QueryString["group_id"].ToString());
        }
    }
}