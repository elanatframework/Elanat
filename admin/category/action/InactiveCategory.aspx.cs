...
namespace elanat
{
    public partial class ActionInactiveCategory : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            duc.Inactive(Request.QueryString["category_id"].ToString());
			...
			rc.StartEvent("inactive_category", Request.QueryString["category_id"].ToString());
        }
    }
}