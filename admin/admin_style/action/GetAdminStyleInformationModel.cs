...
namespace elanat
{
    public class ActionGetAdminStyleInformationModel
    {
        public string GetInformation(string AdminStyleDirectoryPath)
        {
            XmlDocument doc = new XmlDocument();
            doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "client/style/admin/" + AdminStyleDirectoryPath + "/catalog.xml"));
