<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="elanat.AdminOptions" validateRequest="false" %><!DOCTYPE html>
...
<body onload="el_RunAction(); el_PartPageLoad();">
    ...
    <form id="frm_AdminSecurity" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/options/Default.aspx">
         ...
         <div class="el_part_row">
            ...
            <div class="el_item">
                <span class="el_checkbox_input"><input id="cbx_UseHttpOnlyForSessionId" name="cbx_UseHttpOnlyForSessionId" type="checkbox" <%=elanat.AspxHtmlValue.BooleanToCheckedHtmlAttribute(model.UseHttpOnlyForSessionIdValue)%> /><label for="cbx_UseHttpOnlyForSessionId"><%=model.UseHttpOnlyForSessionIdLanguage%></label></span>
            </div>
            <div class="el_item">
            ...
            <div class="el_item">
                <input id="btn_SaveSecurity" name="btn_SaveSecurity" type="submit" class="el_button_input" value="<%=model.SaveSecurityLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_AdminSecurity')" />
            </div>
        </div>
    ...
    <form id="frm_AdminEmail" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/options/Default.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveEmail" name="btn_SaveEmail" type="submit" class="el_button_input" value="<%=model.SaveEmailLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_AdminEmail')" />
            </div>
        </div>
    ...
    <form id="frm_AdminDateAndTime" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/options/Default.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveDateAndTime" name="btn_SaveDateAndTime" type="submit" class="el_button_input" value="<%=model.SaveDateAndTimeLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_AdminDateAndTime')" />
            </div>
        </div>
    ...
    <form id="frm_AdminFileAndDirectory" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/options/Default.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveFileAndDirectory" name="btn_SaveFileAndDirectory" type="submit" class="el_button_input" value="<%=model.SaveFileAndDirectoryLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_AdminFileAndDirectory')" />
            </div>
        </div>
    ...
    <form id="frm_AdminCashe" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/options/Default.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveCache" name="btn_SaveCache" type="submit" class="el_button_input" value="<%=model.SaveCacheLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_AdminCashe')" />
            </div>
        </div>
    ...
    <form id="frm_AdminDelay" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/options/Default.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveDelay" name="btn_SaveDelay" type="submit" class="el_button_input" value="<%=model.SaveDelayLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_AdminDelay')" />
            </div>
        </div>
