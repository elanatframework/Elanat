...
namespace elanat
{
    public class AdminOptionsModel
    {
        ...
        public string UseHttpOnlyForSessionIdLanguage { get; set; }
        ...
        public bool UseHttpOnlyForSessionIdValue { get; set; } = false;
        ...
        public void SetValue()
        {
            ...
            UseHttpOnlyForSessionIdLanguage = aol.GetAddOnsLanguage("use_http_only_for_session_id");
            ...
            doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/config/config.xml"));
            ...
            UseHttpOnlyForSessionIdValue = (node["use_http_only_for_session_id"].Attributes["active"].Value == "true");
            ...
            DefaultGroupOptionListValue += lc.UserGroupListItem.HtmlInputToOptionTag(DefaultGroupOptionListSelectedValue);
            GuestGroupOptionListValue += lc.UserGroupListItem.HtmlInputToOptionTag(GuestGroupOptionListSelectedValue);
            ...
            TimeZoneOptionListValue += lc.TimeZoneListItem.HtmlInputToOptionTag(TimeZoneOptionListSelectedValue);

            // Set Calendar Item
            lc.FillCalendarListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            CalendarOptionListValue += lc.CalendarListItem.HtmlInputToOptionTag(CalendarOptionListSelectedValue, true);
            ...
            FirstDayOfWeekOptionListValue += lc.DayOfWeakListItem.HtmlInputToOptionTag(FirstDayOfWeekOptionListSelectedValue);

            // Set Role Cache Type Item
            lc.FillRoleCacheTypeListItem(StaticObject.GetCurrentAdminGlobalLanguage());
            AdminRoleCacheTypeOptionListValue += lc.RoleCacheTypeListItem.HtmlInputToOptionTag(AdminRoleCacheTypeOptionListSelectedValue);
            MemberRoleCacheTypeOptionListValue += lc.RoleCacheTypeListItem.HtmlInputToOptionTag(MemberRoleCacheTypeOptionListSelectedValue);
            GuestRoleCacheTypeOptionListValue += lc.RoleCacheTypeListItem.HtmlInputToOptionTag(GuestRoleCacheTypeOptionListSelectedValue);
            TextCreatorCacheTypeOptionListValue += lc.RoleCacheTypeListItem.HtmlInputToOptionTag(TextCreatorCacheTypeOptionListSelectedValue);
        }
        ...
        public void SetImportantField()
        {
            ...
            AdminDirectoryPathAttribute += vc.ImportantInputAttribute["txt_AdminDirectoryPath"];
            LockLoginDirectoryPathAttribute += vc.ImportantInputAttribute["txt_LockLoginDirectoryPath"];
            SecretKeyAttribute += vc.ImportantInputAttribute["txt_SecretKey"];
            SystemAccessCodeAttribute += vc.ImportantInputAttribute["txt_SystemAccessCode"];
            LockLoginPasswordAttribute += vc.ImportantInputAttribute["txt_LockLoginPassword"];
            NewPasswordLengthAttribute += vc.ImportantInputAttribute["txt_NewPasswordLength"];
            DataBaseNameAttribute += vc.ImportantInputAttribute["txt_DataBaseName"];
            ConectionStringAttribute += vc.ImportantInputAttribute["txt_ConectionString"];
            UserSecureValueSizeAttribute += vc.ImportantInputAttribute["txt_UserSecureValueSize"];
            NewRandomTextValueCountAttribute += vc.ImportantInputAttribute["txt_NewRandomTextValueCount"];
            CaptchaNoiseAttribute += vc.ImportantInputAttribute["txt_CaptchaNoise"];
            CaptchaCharacterCountFromAttribute += vc.ImportantInputAttribute["txt_CaptchaCharacterCountFrom"];
            CaptchaCharacterCountToAttribute += vc.ImportantInputAttribute["txt_CaptchaCharacterCountTo"];
            CaptchaCharacterAttribute += vc.ImportantInputAttribute["txt_CaptchaCharacter"];
            CaptchaFontAttribute += vc.ImportantInputAttribute["txt_CaptchaFont"];
            CaptchaFontSizeAttribute += vc.ImportantInputAttribute["txt_CaptchaFontSize"];
            CaptchaRotateTransformAttribute += vc.ImportantInputAttribute["txt_CaptchaRotateTransform"];
            CaptchaWidthAttribute += vc.ImportantInputAttribute["txt_CaptchaWidth"];
            CaptchaHeightAttribute += vc.ImportantInputAttribute["txt_CaptchaHeight"];
            CaptchaRepeatTimeAttribute += vc.ImportantInputAttribute["txt_CaptchaRepeatTime"];
            CaptchaAdminReleaseCountAttribute += vc.ImportantInputAttribute["txt_CaptchaAdminReleaseCount"];
            CaptchaMemberReleaseCountAttribute += vc.ImportantInputAttribute["txt_CaptchaMemberReleaseCount"];
            CaptchaGuestReleaseCountAttribute += vc.ImportantInputAttribute["txt_CaptchaGuestReleaseCount"];
            RobotDetectionIpBlockDurationAttribute += vc.ImportantInputAttribute["txt_RobotDetectionIpBlockDuration"];
            RobotDetectionResetTimeDurationAttribute += vc.ImportantInputAttribute["txt_RobotDetectionResetTimeDuration"];
            RobotDetectionAdminRequestCountAttribute += vc.ImportantInputAttribute["txt_RobotDetectionAdminRequestCount"];
            RobotDetectionMemberRequestCountAttribute += vc.ImportantInputAttribute["txt_RobotDetectionMemberRequestCount"];
            RobotDetectionGuestRequestCountAttribute += vc.ImportantInputAttribute["txt_RobotDetectionGuestRequestCount"];
            RobotDetectionAdminRequestAfterShowCaptchaCountAttribute += vc.ImportantInputAttribute["txt_RobotDetectionAdminRequestAfterShowCaptchaCount"];
            RobotDetectionMemberRequestAfterShowCaptchaCountAttribute += vc.ImportantInputAttribute["txt_RobotDetectionMemberRequestAfterShowCaptchaCount"];
            RobotDetectionGuestRequestAfterShowCaptchaCountAttribute += vc.ImportantInputAttribute["txt_RobotDetectionGuestRequestAfterShowCaptchaCount"];
            AdminLifeTimeAttribute += vc.ImportantInputAttribute["txt_AdminLifeTime"];
            MemberLifeTimeAttribute += vc.ImportantInputAttribute["txt_MemberLifeTime"];
            GuestLifeTimeAttribute += vc.ImportantInputAttribute["txt_GuestLifeTime"];
            SessionLifeTimeAttribute += vc.ImportantInputAttribute["txt_SessionLifeTime"];
            CookieLifeTimeAttribute += vc.ImportantInputAttribute["txt_CookieLifeTime"];
            EmailHostAttribute += vc.ImportantInputAttribute["txt_EmailHost"];
            EmailPortAttribute += vc.ImportantInputAttribute["txt_EmailPort"];
            EmailUserNameAttribute += vc.ImportantInputAttribute["txt_EmailUserName"];
            EmailPasswordAttribute += vc.ImportantInputAttribute["txt_EmailPassword"];
            EmailSenderAttribute += vc.ImportantInputAttribute["txt_EmailSender"];
            TextBeforeEmailSubjectAttribute += vc.ImportantInputAttribute["txt_TextBeforeEmailSubject"];
            TextAfterEmailSubjectAttribute += vc.ImportantInputAttribute["txt_TextAfterEmailSubject"];
            TextBeforeEmailBodyAttribute += vc.ImportantInputAttribute["txt_TextBeforeEmailBody"];
            TextAfterEmailBodyAttribute += vc.ImportantInputAttribute["txt_TextAfterEmailBody"];
            ...
            MaximumSizeForBackupAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForBackup"];
            MaximumSizeForUploadAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForUpload"];
            MaximumSizeForAttachmentAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForAttachment"];
            MaximumSizeForPluginAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForPlugin"];
            MaximumSizeForModuleAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForModule"];
            MaximumSizeForComponentAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForComponent"];
            MaximumSizeForExtraHelperAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForExtraHelper"];
            MaximumSizeForEditorTemplateAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForEditorTemplate"];
            MaximumSizeForPatchAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForPatch"];
            MaximumSizeForFetchAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForFetch"];
            MaximumSizeForSiteTemplateAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForSiteTemplate"];
            MaximumSizeForSiteStyleAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForSiteStyle"];
            MaximumSizeForAdminTemplateAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForAdminTemplate"];
            MaximumSizeForAdminStyleAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForAdminStyle"];
            MaximumSizeForCommentAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForComment"];
            MaximumSizeForContactAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForContact"];
            MaximumSizeForPageAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForPage"];
            MaximumSizeForLanguageAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForLanguage"];
            MaximumSizeForContentAvatarAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForContentAvatar"];
            MaximumSizeForUserAvatarAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForUserAvatar"];
            MaximumSizeForUserUploadAttribute += vc.ImportantInputAttribute["txt_MaximumSizeForUserUpload"];
            ThumbnailImageHeightAttribute += vc.ImportantInputAttribute["txt_ThumbnailImageHeight"];
            ThumbnailImageWidthAttribute += vc.ImportantInputAttribute["txt_ThumbnailImageWidth"];
            SiteMainCacheParametersAttribute += vc.ImportantInputAttribute["txt_SiteMainCacheParameters"];
            AdminMainCacheParametersAttribute += vc.ImportantInputAttribute["txt_AdminMainCacheParameters"];
            AdminRoleCacheAttribute += vc.ImportantInputAttribute["txt_AdminRoleCache"];
            MemberRoleCacheAttribute += vc.ImportantInputAttribute["txt_MemberRoleCache"];
            GuestRoleCacheAttribute += vc.ImportantInputAttribute["txt_GuestRoleCache"];
            ClientCacheForDynamicPageCacheAttribute += vc.ImportantInputAttribute["txt_ClientCacheForDynamicPageCache"];
            ClientCacheForStaticPageCacheAttribute += vc.ImportantInputAttribute["txt_ClientCacheForStaticPageCache"];
            TextCreatorServerCacheDurationAttribute += vc.ImportantInputAttribute["txt_TextCreatorServerCacheDuration"];
            TextCreatorClientCacheDurationAttribute += vc.ImportantInputAttribute["txt_TextCreatorClientCacheDuration"];
            MainDelayAttribute += vc.ImportantInputAttribute["txt_MainDelay"];
            SignUpDelayAttribute += vc.ImportantInputAttribute["txt_SignUpDelay"];
            LoginDelayAttribute += vc.ImportantInputAttribute["txt_LoginDelay"];
            LockLoginPageDelayAttribute += vc.ImportantInputAttribute["txt_LockLoginPageDelay"];
            CaptchaDelayAttribute += vc.ImportantInputAttribute["txt_CaptchaDelay"];
            ShowProtectionContentDelayAttribute += vc.ImportantInputAttribute["txt_ShowProtectionContentDelay"];
            ShowProtectionAttachmentDelayAttribute += vc.ImportantInputAttribute["txt_ShowProtectionAttachmentDelay"];
            DefaultGroupAttribute += vc.ImportantInputAttribute["ddlst_DefaultGroup"];
            GuestGroupAttribute += vc.ImportantInputAttribute["ddlst_GuestGroup"];
            ...
            AdminRoleCacheTypeAttribute += vc.ImportantInputAttribute["ddlst_AdminRoleCacheType"];
            MemberRoleCacheTypeAttribute += vc.ImportantInputAttribute["ddlst_MemberRoleCacheType"];
            GuestRoleCacheTypeAttribute += vc.ImportantInputAttribute["ddlst_GuestRoleCacheType"];
            TextCreatorCacheTypeAttribute += vc.ImportantInputAttribute["ddlst_TextCreatorCacheType"];

            AdminDirectoryPathCssClass = AdminDirectoryPathCssClass.AddHtmlClass(vc.ImportantInputClass["txt_AdminDirectoryPath"]);
            LockLoginDirectoryPathCssClass = LockLoginDirectoryPathCssClass.AddHtmlClass(vc.ImportantInputClass["txt_LockLoginDirectoryPath"]);
            SecretKeyCssClass = SecretKeyCssClass.AddHtmlClass(vc.ImportantInputClass["txt_SecretKey"]);
            SystemAccessCodeCssClass = SystemAccessCodeCssClass.AddHtmlClass(vc.ImportantInputClass["txt_SystemAccessCode"]);
            LockLoginPasswordCssClass = LockLoginPasswordCssClass.AddHtmlClass(vc.ImportantInputClass["txt_LockLoginPassword"]);
            NewPasswordLengthCssClass = NewPasswordLengthCssClass.AddHtmlClass(vc.ImportantInputClass["txt_NewPasswordLength"]);
            DataBaseNameCssClass = DataBaseNameCssClass.AddHtmlClass(vc.ImportantInputClass["txt_DataBaseName"]);
            ConectionStringCssClass = ConectionStringCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ConectionString"]);
            UserSecureValueSizeCssClass = UserSecureValueSizeCssClass.AddHtmlClass(vc.ImportantInputClass["txt_UserSecureValueSize"]);
            NewRandomTextValueCountCssClass = NewRandomTextValueCountCssClass.AddHtmlClass(vc.ImportantInputClass["txt_NewRandomTextValueCount"]);
            CaptchaNoiseCssClass = CaptchaNoiseCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaNoise"]);
            CaptchaCharacterCountFromCssClass = CaptchaCharacterCountFromCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaCharacterCountFrom"]);
            CaptchaCharacterCountToCssClass = CaptchaCharacterCountToCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaCharacterCountTo"]);
            CaptchaCharacterCssClass = CaptchaCharacterCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaCharacter"]);
            CaptchaFontCssClass = CaptchaFontCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaFont"]);
            CaptchaFontSizeCssClass = CaptchaFontSizeCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaFontSize"]);
            CaptchaRotateTransformCssClass = CaptchaRotateTransformCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaRotateTransform"]);
            CaptchaWidthCssClass = CaptchaWidthCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaWidth"]);
            CaptchaHeightCssClass = CaptchaHeightCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaHeight"]);
            CaptchaRepeatTimeCssClass = CaptchaRepeatTimeCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaRepeatTime"]);
            CaptchaAdminReleaseCountCssClass = CaptchaAdminReleaseCountCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaAdminReleaseCount"]);
            CaptchaMemberReleaseCountCssClass = CaptchaMemberReleaseCountCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaMemberReleaseCount"]);
            CaptchaGuestReleaseCountCssClass = CaptchaGuestReleaseCountCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaGuestReleaseCount"]);
            RobotDetectionIpBlockDurationCssClass = RobotDetectionIpBlockDurationCssClass.AddHtmlClass(vc.ImportantInputClass["txt_RobotDetectionIpBlockDuration"]);
            RobotDetectionResetTimeDurationCssClass = RobotDetectionResetTimeDurationCssClass.AddHtmlClass(vc.ImportantInputClass["txt_RobotDetectionResetTimeDuration"]);
            RobotDetectionAdminRequestCountCssClass = RobotDetectionAdminRequestCountCssClass.AddHtmlClass(vc.ImportantInputClass["txt_RobotDetectionAdminRequestCount"]);
            RobotDetectionMemberRequestCountCssClass = RobotDetectionMemberRequestCountCssClass.AddHtmlClass(vc.ImportantInputClass["txt_RobotDetectionMemberRequestCount"]);
            RobotDetectionGuestRequestCountCssClass = RobotDetectionGuestRequestCountCssClass.AddHtmlClass(vc.ImportantInputClass["txt_RobotDetectionGuestRequestCount"]);
            RobotDetectionAdminRequestAfterShowCaptchaCountCssClass = RobotDetectionAdminRequestAfterShowCaptchaCountCssClass.AddHtmlClass(vc.ImportantInputClass["txt_RobotDetectionAdminRequestAfterShowCaptchaCount"]);
            RobotDetectionMemberRequestAfterShowCaptchaCountCssClass = RobotDetectionMemberRequestAfterShowCaptchaCountCssClass.AddHtmlClass(vc.ImportantInputClass["txt_RobotDetectionMemberRequestAfterShowCaptchaCount"]);
            RobotDetectionGuestRequestAfterShowCaptchaCountCssClass = RobotDetectionGuestRequestAfterShowCaptchaCountCssClass.AddHtmlClass(vc.ImportantInputClass["txt_RobotDetectionGuestRequestAfterShowCaptchaCount"]);
            AdminLifeTimeCssClass = AdminLifeTimeCssClass.AddHtmlClass(vc.ImportantInputClass["txt_AdminLifeTime"]);
            MemberLifeTimeCssClass = MemberLifeTimeCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MemberLifeTime"]);
            GuestLifeTimeCssClass = GuestLifeTimeCssClass.AddHtmlClass(vc.ImportantInputClass["txt_GuestLifeTime"]);
            SessionLifeTimeCssClass = SessionLifeTimeCssClass.AddHtmlClass(vc.ImportantInputClass["txt_SessionLifeTime"]);
            CookieLifeTimeCssClass = CookieLifeTimeCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CookieLifeTime"]);
            EmailHostCssClass = EmailHostCssClass.AddHtmlClass(vc.ImportantInputClass["txt_EmailHost"]);
            EmailPortCssClass = EmailPortCssClass.AddHtmlClass(vc.ImportantInputClass["txt_EmailPort"]);
            EmailUserNameCssClass = EmailUserNameCssClass.AddHtmlClass(vc.ImportantInputClass["txt_EmailUserName"]);
            EmailPasswordCssClass = EmailPasswordCssClass.AddHtmlClass(vc.ImportantInputClass["txt_EmailPassword"]);
            EmailSenderCssClass = EmailSenderCssClass.AddHtmlClass(vc.ImportantInputClass["txt_EmailSender"]);
            TextBeforeEmailSubjectCssClass = TextBeforeEmailSubjectCssClass.AddHtmlClass(vc.ImportantInputClass["txt_TextBeforeEmailSubject"]);
            TextAfterEmailSubjectCssClass = TextAfterEmailSubjectCssClass.AddHtmlClass(vc.ImportantInputClass["txt_TextAfterEmailSubject"]);
            TextBeforeEmailBodyCssClass = TextBeforeEmailBodyCssClass.AddHtmlClass(vc.ImportantInputClass["txt_TextBeforeEmailBody"]);
            TextAfterEmailBodyCssClass = TextAfterEmailBodyCssClass.AddHtmlClass(vc.ImportantInputClass["txt_TextAfterEmailBody"]);
            ...
            MaximumSizeForBackupCssClass = MaximumSizeForBackupCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForBackup"]);
            MaximumSizeForUploadCssClass = MaximumSizeForUploadCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForUpload"]);
            MaximumSizeForAttachmentCssClass = MaximumSizeForAttachmentCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForAttachment"]);
            MaximumSizeForPluginCssClass = MaximumSizeForPluginCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForPlugin"]);
            MaximumSizeForModuleCssClass = MaximumSizeForModuleCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForModule"]);
            MaximumSizeForComponentCssClass = MaximumSizeForComponentCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForComponent"]);
            MaximumSizeForExtraHelperCssClass = MaximumSizeForExtraHelperCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForExtraHelper"]);
            MaximumSizeForEditorTemplateCssClass = MaximumSizeForEditorTemplateCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForEditorTemplate"]);
            MaximumSizeForPatchCssClass = MaximumSizeForPatchCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForPatch"]);
            MaximumSizeForFetchCssClass = MaximumSizeForFetchCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForFetch"]);
            MaximumSizeForSiteTemplateCssClass = MaximumSizeForSiteTemplateCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForSiteTemplate"]);
            MaximumSizeForSiteStyleCssClass = MaximumSizeForSiteStyleCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForSiteStyle"]);
            MaximumSizeForAdminTemplateCssClass = MaximumSizeForAdminTemplateCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForAdminTemplate"]);
            MaximumSizeForAdminStyleCssClass = MaximumSizeForAdminStyleCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForAdminStyle"]);
            MaximumSizeForCommentCssClass = MaximumSizeForCommentCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForComment"]);
            MaximumSizeForContactCssClass = MaximumSizeForContactCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForContact"]);
            MaximumSizeForPageCssClass = MaximumSizeForPageCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForPage"]);
            MaximumSizeForLanguageCssClass = MaximumSizeForLanguageCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForLanguage"]);
            MaximumSizeForContentAvatarCssClass = MaximumSizeForContentAvatarCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForContentAvatar"]);
            MaximumSizeForUserAvatarCssClass = MaximumSizeForUserAvatarCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForUserAvatar"]);
            MaximumSizeForUserUploadCssClass = MaximumSizeForUserUploadCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MaximumSizeForUserUpload"]);
            ThumbnailImageHeightCssClass = ThumbnailImageHeightCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ThumbnailImageHeight"]);
            ThumbnailImageWidthCssClass = ThumbnailImageWidthCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ThumbnailImageWidth"]);
            SiteMainCacheParametersCssClass = SiteMainCacheParametersCssClass.AddHtmlClass(vc.ImportantInputClass["txt_SiteMainCacheParameters"]);
            AdminMainCacheParametersCssClass = AdminMainCacheParametersCssClass.AddHtmlClass(vc.ImportantInputClass["txt_AdminMainCacheParameters"]);
            AdminRoleCacheCssClass = AdminRoleCacheCssClass.AddHtmlClass(vc.ImportantInputClass["txt_AdminRoleCache"]);
            MemberRoleCacheCssClass = MemberRoleCacheCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MemberRoleCache"]);
            GuestRoleCacheCssClass = GuestRoleCacheCssClass.AddHtmlClass(vc.ImportantInputClass["txt_GuestRoleCache"]);
            ClientCacheForDynamicPageCacheCssClass = ClientCacheForDynamicPageCacheCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ClientCacheForDynamicPageCache"]);
            ClientCacheForStaticPageCacheCssClass = ClientCacheForStaticPageCacheCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ClientCacheForStaticPageCache"]);
            TextCreatorServerCacheDurationCssClass = TextCreatorServerCacheDurationCssClass.AddHtmlClass(vc.ImportantInputClass["txt_TextCreatorServerCacheDuration"]);
            TextCreatorClientCacheDurationCssClass = TextCreatorClientCacheDurationCssClass.AddHtmlClass(vc.ImportantInputClass["txt_TextCreatorClientCacheDuration"]);
            MainDelayCssClass = MainDelayCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MainDelay"]);
            SignUpDelayCssClass = SignUpDelayCssClass.AddHtmlClass(vc.ImportantInputClass["txt_SignUpDelay"]);
            LoginDelayCssClass = LoginDelayCssClass.AddHtmlClass(vc.ImportantInputClass["txt_LoginDelay"]);
            LockLoginPageDelayCssClass = LockLoginPageDelayCssClass.AddHtmlClass(vc.ImportantInputClass["txt_LockLoginPageDelay"]);
            CaptchaDelayCssClass = CaptchaDelayCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CaptchaDelay"]);
            ShowProtectionContentDelayCssClass = ShowProtectionContentDelayCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ShowProtectionContentDelay"]);
            ShowProtectionAttachmentDelayCssClass = ShowProtectionAttachmentDelayCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ShowProtectionAttachmentDelay"]);
            DefaultGroupCssClass = DefaultGroupCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_DefaultGroup"]);
            GuestGroupCssClass = GuestGroupCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_GuestGroup"]);
            ...
            AdminRoleCacheTypeCssClass = AdminRoleCacheTypeCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_AdminRoleCacheType"]);
            MemberRoleCacheTypeCssClass = MemberRoleCacheTypeCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_MemberRoleCacheType"]);
            GuestRoleCacheTypeCssClass = GuestRoleCacheTypeCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_GuestRoleCacheType"]);
            TextCreatorCacheTypeCssClass = TextCreatorCacheTypeCssClass.AddHtmlClass(vc.ImportantInputClass["ddlst_TextCreatorCacheType"]);
        }

        public void SecurityEvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
            ...
            if (!vc.TrueContinue)
            {
                ...
                //AdminDirectoryPathCssClass = AdminDirectoryPathCssClass.AddHtmlClass(vc.WarningFieldClass["txt_AdminDirectoryPath"]);
                //LockLoginDirectoryPathCssClass = LockLoginDirectoryPathCssClass.AddHtmlClass(vc.WarningFieldClass["txt_LockLoginDirectoryPath"]);
                //SecretKeyCssClass = SecretKeyCssClass.AddHtmlClass(vc.WarningFieldClass["txt_SecretKey"]);
                //SystemAccessCodeCssClass = SystemAccessCodeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_SystemAccessCode"]);
                //LockLoginPasswordCssClass = LockLoginPasswordCssClass.AddHtmlClass(vc.WarningFieldClass["txt_LockLoginPassword"]);
                //NewPasswordLengthCssClass = NewPasswordLengthCssClass.AddHtmlClass(vc.WarningFieldClass["txt_NewPasswordLength"]);
                //DataBaseNameCssClass = DataBaseNameCssClass.AddHtmlClass(vc.WarningFieldClass["txt_DataBaseName"]);
                //ConectionStringCssClass = ConectionStringCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ConectionString"]);
                //UserSecureValueSizeCssClass = UserSecureValueSizeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_UserSecureValueSize"]);
                //NewRandomTextValueCountCssClass = NewRandomTextValueCountCssClass.AddHtmlClass(vc.WarningFieldClass["txt_NewRandomTextValueCount"]);
                //CaptchaNoiseCssClass = CaptchaNoiseCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaNoise"]);
                //CaptchaCharacterCountFromCssClass = CaptchaCharacterCountFromCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaCharacterCountFrom"]);
                //CaptchaCharacterCountToCssClass = CaptchaCharacterCountToCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaCharacterCountTo"]);
                //CaptchaCharacterCssClass = CaptchaCharacterCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaCharacter"]);
                //CaptchaFontCssClass = CaptchaFontCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaFont"]);
                //CaptchaFontSizeCssClass = CaptchaFontSizeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaFontSize"]);
                //CaptchaRotateTransformCssClass = CaptchaRotateTransformCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaRotateTransform"]);
                //CaptchaWidthCssClass = CaptchaWidthCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaWidth"]);
                //CaptchaHeightCssClass = CaptchaHeightCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaHeight"]);
                //CaptchaRepeatTimeCssClass = CaptchaRepeatTimeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaRepeatTime"]);
                //CaptchaAdminReleaseCountCssClass = CaptchaAdminReleaseCountCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaAdminReleaseCount"]);
                //CaptchaMemberReleaseCountCssClass = CaptchaMemberReleaseCountCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaMemberReleaseCount"]);
                //CaptchaGuestReleaseCountCssClass = CaptchaGuestReleaseCountCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaGuestReleaseCount"]);
                //RobotDetectionIpBlockDurationCssClass = RobotDetectionIpBlockDurationCssClass.AddHtmlClass(vc.WarningFieldClass["txt_RobotDetectionIpBlockDuration"]);
                //RobotDetectionResetTimeDurationCssClass = RobotDetectionResetTimeDurationCssClass.AddHtmlClass(vc.WarningFieldClass["txt_RobotDetectionResetTimeDuration"]);
                //RobotDetectionAdminRequestCountCssClass = RobotDetectionAdminRequestCountCssClass.AddHtmlClass(vc.WarningFieldClass["txt_RobotDetectionAdminRequestCount"]);
                //RobotDetectionMemberRequestCountCssClass = RobotDetectionMemberRequestCountCssClass.AddHtmlClass(vc.WarningFieldClass["txt_RobotDetectionMemberRequestCount"]);
                //RobotDetectionGuestRequestCountCssClass = RobotDetectionGuestRequestCountCssClass.AddHtmlClass(vc.WarningFieldClass["txt_RobotDetectionGuestRequestCount"]);
                //RobotDetectionAdminRequestAfterShowCaptchaCountCssClass = RobotDetectionAdminRequestAfterShowCaptchaCountCssClass.AddHtmlClass(vc.WarningFieldClass["txt_RobotDetectionAdminRequestAfterShowCaptchaCount"]);
                //RobotDetectionMemberRequestAfterShowCaptchaCountCssClass = RobotDetectionMemberRequestAfterShowCaptchaCountCssClass.AddHtmlClass(vc.WarningFieldClass["txt_RobotDetectionMemberRequestAfterShowCaptchaCount"]);
                //RobotDetectionGuestRequestAfterShowCaptchaCountCssClass = RobotDetectionGuestRequestAfterShowCaptchaCountCssClass.AddHtmlClass(vc.WarningFieldClass["txt_RobotDetectionGuestRequestAfterShowCaptchaCount"]);
                //AdminLifeTimeCssClass = AdminLifeTimeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_AdminLifeTime"]);
                //MemberLifeTimeCssClass = MemberLifeTimeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MemberLifeTime"]);
                //GuestLifeTimeCssClass = GuestLifeTimeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_GuestLifeTime"]);
                //SessionLifeTimeCssClass = SessionLifeTimeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_SessionLifeTime"]);
                //CookieLifeTimeCssClass = CookieLifeTimeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CookieLifeTime"]);
                //DefaultGroupCssClass = DefaultGroupCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_DefaultGroup"]);
                //GuestGroupCssClass = GuestGroupCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_GuestGroup"]);
            }
        }

        public void EmailEvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
            ...
            if (!vc.TrueContinue)
            {
                ...
                //EmailHostCssClass = EmailHostCssClass.AddHtmlClass(vc.WarningFieldClass["txt_EmailHost"]);
                //EmailPortCssClass = EmailPortCssClass.AddHtmlClass(vc.WarningFieldClass["txt_EmailPort"]);
                //EmailUserNameCssClass = EmailUserNameCssClass.AddHtmlClass(vc.WarningFieldClass["txt_EmailUserName"]);
                //EmailPasswordCssClass = EmailPasswordCssClass.AddHtmlClass(vc.WarningFieldClass["txt_EmailPassword"]);
                //EmailSenderCssClass = EmailSenderCssClass.AddHtmlClass(vc.WarningFieldClass["txt_EmailSender"]);
                //TextBeforeEmailSubjectCssClass = TextBeforeEmailSubjectCssClass.AddHtmlClass(vc.WarningFieldClass["txt_TextBeforeEmailSubject"]);
                //TextAfterEmailSubjectCssClass = TextAfterEmailSubjectCssClass.AddHtmlClass(vc.WarningFieldClass["txt_TextAfterEmailSubject"]);
                //TextBeforeEmailBodyCssClass = TextBeforeEmailBodyCssClass.AddHtmlClass(vc.WarningFieldClass["txt_TextBeforeEmailBody"]);
                //TextAfterEmailBodyCssClass = TextAfterEmailBodyCssClass.AddHtmlClass(vc.WarningFieldClass["txt_TextAfterEmailBody"]);
            }
        }

        public void DateAndTimeEvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
        ...
        public void FileAndDirectoryEvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
            ...
            if (!vc.TrueContinue)
            {
                ...
                //MaximumSizeForBackupCssClass = MaximumSizeForBackupCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForBackup"]);
                //MaximumSizeForUploadCssClass = MaximumSizeForUploadCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForUpload"]);
                //MaximumSizeForAttachmentCssClass = MaximumSizeForAttachmentCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForAttachment"]);
                //MaximumSizeForPluginCssClass = MaximumSizeForPluginCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForPlugin"]);
                //MaximumSizeForModuleCssClass = MaximumSizeForModuleCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForModule"]);
                //MaximumSizeForComponentCssClass = MaximumSizeForComponentCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForComponent"]);
                //MaximumSizeForExtraHelperCssClass = MaximumSizeForExtraHelperCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForExtraHelper"]);
                //MaximumSizeForEditorTemplateCssClass = MaximumSizeForEditorTemplateCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForEditorTemplate"]);
                //MaximumSizeForPatchCssClass = MaximumSizeForPatchCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForPatch"]);
                //MaximumSizeForFetchCssClass = MaximumSizeForFetchCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForFetch"]);
                //MaximumSizeForSiteTemplateCssClass = MaximumSizeForSiteTemplateCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForSiteTemplate"]);
                //MaximumSizeForSiteStyleCssClass = MaximumSizeForSiteStyleCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForSiteStyle"]);
                //MaximumSizeForAdminTemplateCssClass = MaximumSizeForAdminTemplateCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForAdminTemplate"]);
                //MaximumSizeForAdminStyleCssClass = MaximumSizeForAdminStyleCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForAdminStyle"]);
                //MaximumSizeForCommentCssClass = MaximumSizeForCommentCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForComment"]);
                //MaximumSizeForContactCssClass = MaximumSizeForContactCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForContact"]);
                //MaximumSizeForPageCssClass = MaximumSizeForPageCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForPage"]);
                //MaximumSizeForLanguageCssClass = MaximumSizeForLanguageCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForLanguage"]);
                //MaximumSizeForContentAvatarCssClass = MaximumSizeForContentAvatarCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForContentAvatar"]);
                //MaximumSizeForUserAvatarCssClass = MaximumSizeForUserAvatarCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForUserAvatar"]);
                //MaximumSizeForUserUploadCssClass = MaximumSizeForUserUploadCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MaximumSizeForUserUpload"]);
                //ThumbnailImageHeightCssClass = ThumbnailImageHeightCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ThumbnailImageHeight"]);
                //ThumbnailImageWidthCssClass = ThumbnailImageWidthCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ThumbnailImageWidth"]);
            }
        }

        public void DelayEvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
            ...
            if (!vc.TrueContinue)
            {
                ...
                //MainDelayCssClass = MainDelayCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MainDelay"]);
                //SignUpDelayCssClass = SignUpDelayCssClass.AddHtmlClass(vc.WarningFieldClass["txt_SignUpDelay"]);
                //LoginDelayCssClass = LoginDelayCssClass.AddHtmlClass(vc.WarningFieldClass["txt_LoginDelay"]);
                //LockLoginPageDelayCssClass = LockLoginPageDelayCssClass.AddHtmlClass(vc.WarningFieldClass["txt_LockLoginPageDelay"]);
                //CaptchaDelayCssClass = CaptchaDelayCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CaptchaDelay"]);
                //ShowProtectionContentDelayCssClass = ShowProtectionContentDelayCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ShowProtectionContentDelay"]);
                //ShowProtectionAttachmentDelayCssClass = ShowProtectionAttachmentDelayCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ShowProtectionAttachmentDelay"]);
            }
        }

        public void CacheEvaluateField(NameValueCollection FormData)
        {
            ValidationClass vc = new ValidationClass();
            ...
            if (!vc.TrueContinue)
            {
                ...
                //SiteMainCacheParametersCssClass = SiteMainCacheParametersCssClass.AddHtmlClass(vc.WarningFieldClass["txt_SiteMainCacheParameters"]);
                //AdminMainCacheParametersCssClass = AdminMainCacheParametersCssClass.AddHtmlClass(vc.WarningFieldClass["txt_AdminMainCacheParameters"]);
                //AdminRoleCacheCssClass = AdminRoleCacheCssClass.AddHtmlClass(vc.WarningFieldClass["txt_AdminRoleCache"]);
                //MemberRoleCacheCssClass = MemberRoleCacheCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MemberRoleCache"]);
                //GuestRoleCacheCssClass = GuestRoleCacheCssClass.AddHtmlClass(vc.WarningFieldClass["txt_GuestRoleCache"]);
                //ClientCacheForDynamicPageCacheCssClass = ClientCacheForDynamicPageCacheCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ClientCacheForDynamicPageCache"]);
                //ClientCacheForStaticPageCacheCssClass = ClientCacheForStaticPageCacheCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ClientCacheForStaticPageCache"]);
                //TextCreatorServerCacheDurationCssClass = TextCreatorServerCacheDurationCssClass.AddHtmlClass(vc.WarningFieldClass["txt_TextCreatorServerCacheDuration"]);
                //TextCreatorClientCacheDurationCssClass = TextCreatorClientCacheDurationCssClass.AddHtmlClass(vc.WarningFieldClass["txt_TextCreatorClientCacheDuration"]);
                //AdminRoleCacheTypeCssClass = AdminRoleCacheTypeCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_AdminRoleCacheType"]);
                //MemberRoleCacheTypeCssClass = MemberRoleCacheTypeCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_MemberRoleCacheType"]);
                //GuestRoleCacheTypeCssClass = GuestRoleCacheTypeCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_GuestRoleCacheType"]);
                //TextCreatorCacheTypeCssClass = TextCreatorCacheTypeCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_TextCreatorCacheType"]);
            }
        }
        ...
        public void SaveSecurity()
        {
            ...
            doc.SelectSingleNode("elanat_root/security/use_http_only_for_session_id").Attributes["active"].Value = UseHttpOnlyForSessionIdValue ? "true" : "false";
            ...
            doc.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/config/config.xml"));
