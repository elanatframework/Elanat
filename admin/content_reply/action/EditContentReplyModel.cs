...
namespace elanat
{
    public class ActionEditContentReplyModel
    {
        ...
        public void SetImportantField()
        {
            ...
            ContentReplyDateSendAttribute += vc.ImportantInputAttribute["txt_ ContentReplyDateSend"];
            ContentReplyTimeSendAttribute += vc.ImportantInputAttribute["txt_ ContentReplyTimeSend"];
            ...
            ContentReplyDateSendCssClass = ContentReplyDateSendCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ContentReplyDateSend"]);
            ContentReplyTimeSendCssClass = ContentReplyTimeSendCssClass.AddHtmlClass(vc.ImportantInputClass["txt_ContentReplyTimeSend"]);
        }
        ...
        public void EvaluateField(NameValueCollection FormData)
        {
            ...
            if (!vc.TrueContinue)
            {
                ...
                //ContentReplyDateSendCssClass = ContentReplyDateSendCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ContentReplyDateSend"]);
                //ContentReplyTimeSendCssClass = ContentReplyTimeSendCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ContentReplyTimeSend"]);
            }
        }
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.AdminPath + "/content_reply/action/SuccessMessage.aspx");
        }
    }
}