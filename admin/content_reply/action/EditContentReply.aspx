<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditContentReply.aspx.cs" Inherits="elanat.ActionEditContentReply" %><!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" dir="<%=elanat.AspxHtmlValue.CurrentAdminLanguageDirection()%>">
<head>
    <title><%=model.EditContentReplyLanguage%></title>
...
<body onload="el_PartPageLoad();">
    <form id="frm_ActionEditContentReply" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/content_reply/action/EditContentReply.aspx">

        <div class="el_part_row">
            <div id="div_EditContentReplyTitle" class="el_title" onclick="el_HidePart(this); el_SetIframeAutoHeight()">
                <%=model.EditContentReplyLanguage%>
            ...
            <div class="el_item">
                <span class="el_checkbox_input"><input id="cbx_ContentReplyActive" name="cbx_ContentReplyActive" type="checkbox" <%=elanat.AspxHtmlValue.BooleanToCheckedHtmlAttribute(model.ContentReplyActiveValue)%> /><label for="cbx_ContentReplyActive"><%=model.ContentReplyActiveLanguage%></label></span>
            </div>
            <div class="el_item">
            ...
            <div class="el_item">
                 <%=model.ContentReplyDateSendLanguage%>
            </div>
            <div class="el_item">
                <input id="txt_ContentReplyDateSend" name="txt_ContentReplyDateSend" type="text" value="<%=model.ContentReplyDateSendValue%>" class="el_text_input el_left_to_right<%=model.ContentReplyDateSendCssClass%>" <%=model.ContentReplyDateSendAttribute%> />
            </div>
            <div class="el_item">
                 <%=model.ContentReplyTimeSendLanguage%>
            </div>
            <div class="el_item">
                <input id="txt_ContentReplyTimeSend" name="txt_ContentReplyTimeSend" type="text" value="<%=model.ContentReplyTimeSendValue%>" class="el_text_input el_left_to_right<%=model.ContentReplyTimeSendCssClass%>" <%=model.ContentReplyTimeSendAttribute%> />
            </div>
            <div class="el_item">
                <input id="btn_SaveContentReply" name="btn_SaveContentReply" type="submit" class="el_button_input" value="<%=model.SaveContentReplyLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionEditContentReply')" />
            </div>
        </div>

        <input id="hdn_ContentReplyId" name="hdn_ContentReplyId" type="hidden" value="<%=model.ContentReplyIdValue%>" />
