<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPlugin.aspx.cs" Inherits="elanat.ActionEditPlugin" %><!DOCTYPE html>
...
<body onload="el_PartPageLoad();">
    <form id="frm_ActionEditPlugin" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/plugin/action/EditPlugin.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SavePlugin" name="btn_SavePlugin" type="submit" class="el_button_input" value="<%=model.SavePluginLanguage%>" onclick="el_AjaxPostBack(this)" />
            </div>
        </div>
