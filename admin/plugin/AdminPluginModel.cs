...
namespace elanat
{
    public class AdminPluginModel
    {
        ...
        public HttpPostedFile PluginPathUploadValue { get; set; }
        ...
        public void SetImportantField()
        {
            ...
            PluginNameAttribute += vc.ImportantInputAttribute["txt_PluginName"];
            ...
            PluginNameCssClass = PluginNameCssClass.AddHtmlClass(vc.ImportantInputClass["txt_PluginName"]);
        ...
        public void EvaluateField(NameValueCollection FormData)
        {
            ...
            if (!vc.TrueContinue)
            {
                ...
                //PluginNameCssClass = PluginNameCssClass.AddHtmlClass(vc.WarningFieldClass["txt_PluginName"]);
        ...
        public void AddPlugin()
        {
            ...
            if (UsePluginPathValue)
            {
                ...
                DirectoryName = FileAndDirectory.GetNewDirectoryNameIfDirectoryExist(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/"), Path.GetFileNameWithoutExtension(PluginFilePhysicalName));

                Directory.CreateDirectory(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/") + "/" + DirectoryName);
                webClient.DownloadFile(PluginPathTextValue, HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + PluginFilePhysicalName));
            }
            else
            {
                ...
                Directory.CreateDirectory(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/") + "/" + DirectoryName);
                PluginPathUploadValue.SaveAs(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + PluginFilePhysicalName));
            }

            // Check Plugin File Size
            double FileSize = new FileInfo(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + PluginFilePhysicalName)).Length;
            ...
            if (FileExtension == ".zip")
            {
                ...
                zfs.UnZip(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + PluginFilePhysicalName), HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName), true);

                if (!Directory.Exists(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/plugin")))
                {
                    // Delete Physical File
                    Directory.Delete(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName), true);
                ...
                CatalogDocument.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/plugin/catalog.xml"));
                ...
                PluginDirectoryPath = FileAndDirectory.GetNewDirectoryNameIfDirectoryExist(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/plugin/"), PluginDirectoryPath);
                ...
                Directory.Move(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/plugin/"), HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/plugin/" + PluginDirectoryPath));
                ...
                if (Directory.Exists(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/root/")))
                {
                    ...
                    rci.AddTmpBinAddOnToTmpBinFileList(rci.BinFileName, TmpPluginCatalog["plugin_name"].Attributes["value"].Value, "plugin", PluginDirectoryPath);
                    ...
                    UninstallDocument.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/plugin/" + PluginDirectoryPath + "/uninstall.xml"));
            ...
            else
            {
                ...
                PluginName = FileAndDirectory.GetNewDirectoryNameIfDirectoryExist(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/plugin/"), PluginName);

                FileAndDirectory.DirectoryCopy(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName), HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/plugin/" + PluginName), true);
                PriorityForPlugin = false;
                PluginDirectoryPath = PluginName;

                NewCatalogDocument.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/plugin/" + PluginName + "/catalog.xml"));


                // Set Plugin Default Image
                System.IO.File.Copy(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/elanat_system_data/empty_patern/plugin/image.png"), HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/plugin/" + PluginName + "/image.png"));
            }
            ...
            CatalogDocument.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/plugin/" + PluginDirectoryPath + "/catalog.xml"));
