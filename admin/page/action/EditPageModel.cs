...
namespace elanat
{
    public class ActionEditPageModel
    {
        ...
        public void SetValue()
        {
            ...
            lc.FillPageSiteListItem(PageIdValue);
            PageSiteTemplateValue = PageSiteTemplateValue.HtmlInputSetCheckBoxListValue(lc.PageSiteListItem);
            ...
            lc.FillPageAccessShowListItem(PageIdValue);
            PageAccessShowTemplateValue = PageAccessShowTemplateValue.HtmlInputSetCheckBoxListValue(lc.PageAccessShowListItem);
        }
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.AdminPath + "/page/action/SuccessMessage.aspx");
        }

        public void ExistValueToColumnPageGlobalNameErrorView()
        {
            HttpContext.Current.Response.Write(Language.GetLanguage("please_set_new_value_to_asp_field_because_this_is_duplicate", StaticObject.GetCurrentAdminGlobalLanguage()).Replace("$_asp field_name;", Language.GetAddOnsLanguage("page_global_name", StaticObject.GetCurrentAdminGlobalLanguage(), StaticObject.AdminPath + "/page/")));
        }

        public void ExistValueToColumnPageNameErrorView()
        {
            HttpContext.Current.Response.Write(Language.GetLanguage("please_set_new_value_to_asp_field_because_this_is_duplicate", StaticObject.GetCurrentAdminGlobalLanguage()).Replace("$_asp field_name;", Language.GetAddOnsLanguage("page_name", StaticObject.GetCurrentAdminGlobalLanguage(), StaticObject.AdminPath + "/page/")));
        }
    }
}