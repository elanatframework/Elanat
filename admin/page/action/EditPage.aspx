<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditPage.aspx.cs" Inherits="elanat.ActionEditPage" validateRequest="false" %><!DOCTYPE html>
...
<body onload="el_PartPageLoad();">
    <form id="frm_ActionEditPage" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/page/action/EditPage.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SavePage" name="btn_SavePage" type="submit" class="el_button_input" value="<%=model.SavePageLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionEditPage')" />
            </div>
        </div>
