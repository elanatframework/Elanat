...
namespace elanat
{
    public class ActionEditCommentModel
    {
        ...
        public void SetImportantField()
        {
            ...
            CommentDateSendAttribute += vc.ImportantInputAttribute["txt_CommentDateSend"];
            CommentTimeSendAttribute += vc.ImportantInputAttribute["txt_CommentTimeSend"];
            ...
            CommentDateSendCssClass = CommentDateSendCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CommentDateSend"]);
            CommentTimeSendCssClass = CommentTimeSendCssClass.AddHtmlClass(vc.ImportantInputClass["txt_CommentTimeSend"]);
        }
        ...
        public void EvaluateField(NameValueCollection FormData)
        {
            ...
            if (!vc.TrueContinue)
            {
                ...
                //CommentDateSendCssClass = CommentDateSendCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CommentDateSend"]);
                //CommentTimeSendCssClass = CommentTimeSendCssClass.AddHtmlClass(vc.WarningFieldClass["txt_CommentTimeSend"]);
            }
        }
        ...
        public void SaveComment()
        {
            ...
            {
                if (File.Exists(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/comment/" + CommentUploadDirectoryValue + "/" + CommentUploadFileValue)))
                    File.Delete(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/comment/" + CommentUploadDirectoryValue + "/" + CommentUploadFileValue));

                // Delete Thumbnail Image
                if (FileAndDirectory.IsImageExtension(Path.GetExtension(CommentUploadFileValue)))
                {
                    if (File.Exists(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/comment/" + CommentUploadDirectoryValue + "/thumb/" + CommentUploadFileValue)))
                        File.Delete(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/comment/" + CommentUploadDirectoryValue + "/thumb/" + CommentUploadFileValue));

                    int ThumbnailDirectoryLength = System.IO.Directory.GetDirectories(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/comment/" + CommentUploadDirectoryValue + "/thumb/")).Length;
                    int ThumbnailFileLength = System.IO.Directory.GetFiles(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/comment/" + CommentUploadDirectoryValue + "/thumb/")).Length;

                    if (ThumbnailDirectoryLength == 0 && ThumbnailFileLength == 0)
                        Directory.Delete(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/comment/" + CommentUploadDirectoryValue + "/thumb/"), true);
                }

                int DirectoryLength = System.IO.Directory.GetDirectories(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/comment/" + CommentUploadDirectoryValue)).Length;
                int FileLength = System.IO.Directory.GetFiles(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/comment/" + CommentUploadDirectoryValue)).Length;

                if (DirectoryLength == 0 && FileLength == 0)
                    Directory.Delete(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/comment/" + CommentUploadDirectoryValue), true);
            }
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.AdminPath + "/comment/action/SuccessMessage.aspx");
        }
    }
}