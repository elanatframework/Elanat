<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditComment.aspx.cs" Inherits="elanat.ActionEditComment" %><!DOCTYPE html>
...
<body onload="el_PartPageLoad();">
    <form id="frm_ActionEditComment" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/comment/action/EditComment.aspx" enctype="multipart/form-data">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveComment" name="btn_SaveComment" type="submit" class="el_button_input" value="<%=model.SaveCommentLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionEditComment')" />
            </div>
        </div>
