<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditFetch.aspx.cs" Inherits="elanat.ActionEditFetch" ValidateRequest="false" %><!DOCTYPE html>
...
<body onload="el_PartPageLoad();">
    <form id="frm_ActionEditFetch" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/fetch/action/EditFetch.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_GetSqlQueryColumn" name="btn_GetSqlQueryColumn" type="submit" class="el_button_input" value="<%=model.GetSqlQueryColumnLanguage%>" onclick="el_AjaxPostBack(this)" />
            </div>
            <div class="el_item">
            ...
            <div class="el_item">
                <input id="btn_SaveFetch" name="btn_SaveFetch" type="submit" class="el_button_input" value="<%=model.SaveFetchLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_ActionEditFetch')" />
            </div>
        </div>
