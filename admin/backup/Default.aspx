<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="elanat.AdminBackup" %><!DOCTYPE html>
    ...
    <div id="div_MakeBackupItem" class="el_hidden"">
        ...
        <form id="frm_AdminMakeBackup" method="post" action="<%=elanat.AspxHtmlValue.AdminPath()%>/backup/Default.aspx">
            ...
            <div class="el_part_row">
                ...
                <div class="el_item">
                    <span class="el_checkbox_input"><input id="cbx_WebConfigFile" name="cbx_WebConfigFile" type="checkbox" <%=elanat.AspxHtmlValue.BooleanToCheckedHtmlAttribute(model.WebConfigFileValue)%> /><label for="cbx_WebConfigFile"><%=model.WebConfigFileLanguage%></label></span>
                </div>
                <div class="el_item">
