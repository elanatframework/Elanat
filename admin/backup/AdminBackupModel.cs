...
namespace elanat
{
    public class AdminBackupModel
    {
        ...
        public string WebConfigFileLanguage { get; set; }
        ...
        public bool WebConfigFileValue { get; set; } = false;

        public HttpPostedFile BackupPathUploadValue { get; set; }
        ...
        public void SetValue()
        {
            ...
            WebConfigFileLanguage = aol.GetAddOnsLanguage("web_config_file");
            ...
            DirectoryInfo DirInfo = new DirectoryInfo(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "backup/"));
        ...
        public void StartBackup()
        {
            ...
            FileName = FileAndDirectory.GetNewFileNameIfFileNameExist(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "backup/"), FileName);
            ...
            {
                DirectoryInfo[] dirget = new DirectoryInfo(HttpContext.Current.Server.MapPath(StaticObject.SitePath)).GetDirectories();

                DirectoryInfo dirInfo = new DirectoryInfo(HttpContext.Current.Server.MapPath(StaticObject.SitePath));
                ...
                foreach (DirectoryInfo dir in dirget)
                {
                    ...
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + dir.Name));
                }

                foreach (FileInfo file in fileInfo)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + file.Name));


                zip.CreateZip(FileDirectoryPath.ToArray(), HttpContext.Current.Server.MapPath(StaticObject.SitePath + "backup/" + FileName));
            ...
            else
            {
                ...
                if (ActionDirectoryValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "action/"));

                if (AddOnDirectoryValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/"));

                if (AdminDirectoryValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.AdminPath));

                if (AppDataDirectoryValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/"));

                if (BinDirectoryValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "bin/"));

                if (ClientDirectoryValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "client/"));

                if (IncludeDirectoryValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "include/"));

                if (LanguageDirectoryValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "language/"));

                if (MemberDirectoryValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "member/"));

                if (PageDirectoryValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "page/"));

                if (TemplateDirectoryValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "template/"));

                if (UploadDirectoryValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/"));

                if (RobotsTxtFileValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "robots.txt"));

                if (WebConfigFileValue)
                    FileDirectoryPath.Add(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "Web.config"));
            ...
            if (DataBaseValue)
            {
                ...
                DataBaseFileName = FileAndDirectory.GetNewFileNameIfFileNameExist(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "backup/"), DataBaseFileName);

                DataBaseSocket db = new DataBaseSocket();
                db.SetProcedure("start_backup", new List<string>() { "@database_name", "@backup_directory_path", "@backup_physical_name" }, new List<string>() { ElanatConfig.GetNode("/security/database_name").Attributes["value"].Value, HttpContext.Current.Server.MapPath(StaticObject.SitePath + "backup/"), DataBaseFileName });
        ...
        public void StartUpload()
        {
            ...
            if (UseBackupPathValue)
            {
                ...
                BackupFilePhysicalName = System.IO.Path.GetFileName(BackupPathTextValue);

                FileExtension = System.IO.Path.GetExtension(BackupFilePhysicalName);

                DirectoryName = FileAndDirectory.GetNewDirectoryNameIfDirectoryExist(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/"), "backup");

                System.IO.Directory.CreateDirectory(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName));
                webClient.DownloadFile(BackupPathTextValue, HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + BackupFilePhysicalName));
            }
            else
            {
                ...
                BackupFilePhysicalName = System.IO.Path.GetFileName(BackupPathUploadValue.FileName);
                ...
                System.IO.Directory.CreateDirectory(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName));
                BackupPathUploadValue.SaveAs(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + BackupFilePhysicalName));
            }
            ...
            long FileSize = new FileInfo(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + BackupFilePhysicalName)).Length;
            ...
            string BackupFilePhysicalNewName = FileAndDirectory.GetNewFileNameIfFileNameExist(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "backup/"), BackupFilePhysicalName);

            File.Move(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + BackupFilePhysicalName), HttpContext.Current.Server.MapPath(StaticObject.SitePath + "backup/" + BackupFilePhysicalNewName));
