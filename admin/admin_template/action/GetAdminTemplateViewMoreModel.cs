...
namespace elanat
{
    public class ActionGetAdminTemplateViewMoreModel
    {
        public string GetViewMore(string AdminTemplateId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/admin_template/");
