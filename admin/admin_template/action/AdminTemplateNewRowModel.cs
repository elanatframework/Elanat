...
namespace elanat
{
    public class ActionAdminTemplateNewRowModel
    {
        ...
        public void SetValue()
        {
            ...
            TmpRowBoxTemplate = TmpRowBoxTemplate.Replace("$_asp admin_template_extension_name;", System.IO.Path.GetExtension(duat.ReturnDr["admin_template_physical_path"].ToString()).Remove(0, 1));
