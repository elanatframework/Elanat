...
namespace elanat
{
    public class ActionGetAdminTemplateInformationModel
    {
        public string GetInformation(string AdminTemplateDirectoryPath)
        {
            XmlDocument doc = new XmlDocument();
            doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "template/admin/" + AdminTemplateDirectoryPath + "/catalog.xml"));
