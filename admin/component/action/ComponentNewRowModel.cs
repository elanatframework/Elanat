...
namespace elanat
{
    public class ActionComponentNewRowModel
    {
        ...
        public void SetValue()
        {
            ...
            TmpRowBoxTemplate = TmpRowBoxTemplate.Replace("$_asp component_extension_name;", System.IO.Path.GetExtension(duc.ReturnDr["component_physical_path"].ToString()).Remove(0, 1));
