...
namespace elanat
{
    public class CategoryClass
    {
        ...
        public List<string> GetParentCategory(string SiteGlobalName, string CategoryId)
        {
            ...
            ParentCategoryDocument.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/elanat_system_data/site_data/" + SiteGlobalName + "/category_map/category_map.xml"));
