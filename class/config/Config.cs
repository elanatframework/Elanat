...
namespace elanat
{
    public class WebConfig
    {
        public static XmlNode GetNode(string TagPath)
        {
            ...
            doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "Web.config.xml"));
        ...
        public static void SetWebConfig(string value, string TagName, int Item = 0, string Attr = null)
        {
            ...
            doc.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "Web.config.xml"));
        }
    }
}