    ...
    public class Language
    {
        ...
        public static void EditHandheldLanguageVariant(string LanguageVariant, string LanguageValue, string GlobalLanguage)
        {
            try
            {
                ...
                string XmlPath = HttpContext.Current.Server.MapPath(StaticObject.SitePath + "language/" + GlobalLanguage + "/handheld.xml");
                XmlDocument doc = new XmlDocument();
                doc.Load(XmlPath);
        ...
        public static void EditLanguageVariant(string LanguageVariant, string LanguageValue, string GlobalLanguage)
        {
            try
            {
                ...
                string XmlPath = HttpContext.Current.Server.MapPath(StaticObject.SitePath + "language/" + GlobalLanguage + "/" + GlobalLanguage + ".xml");
                XmlDocument doc = new XmlDocument();
                doc.Load(XmlPath);
