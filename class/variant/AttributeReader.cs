    ...
    public class AttributeReader
    {
        ...
        public string GetModule(string ModuleIdVariant, string GlobalLanguage)
        {
            ...
            else
            {
                ...
                GlobalClass.Alert(Language.GetLanguage("module_asp_is_not_existed", GlobalLanguage).Replace("$_asp module_id;", ModuleIdVariant), GlobalLanguage, "problem");
                return "";
            }
        }
            ...
            while (Content.Contains("$_module_id "))
            {
                ...
                if (StaticObject.UseVariantDebug)
                    if (!Content.Contains("$_module_id " + Variable + ";"))
                        GlobalClass.Alert(Language.GetLanguage("do_not_find_semicolon_in_asp_variant", GlobalLanguage).Replace("$_asp variant;", "$_module_id " + Variable + ";"), GlobalLanguage, "problem");
            ...
            while (Content.Contains("$_module_name "))
            {
                ...
                if (StaticObject.UseVariantDebug)
                    if (!Content.Contains("$_module_name " + Variable + ";"))
                        GlobalClass.Alert(Language.GetLanguage("do_not_find_semicolon_in_asp_variant", GlobalLanguage).Replace("$_asp variant;", "$_module_name " + Variable + ";"), GlobalLanguage, "problem");
        ...
        public string GetPlugin(string PluginIdVariant, string GlobalLanguage)
        {
            ...
            else
            {
                ...
                GlobalClass.Alert(Language.GetLanguage("plugin_asp_is_not_existed", GlobalLanguage).Replace("$_asp plugin_id;", PluginIdVariant), GlobalLanguage, "problem");
                return "";
            }
        }
            ...
            while (Content.Contains("$_plugin_id "))
            {
                ...
                if (StaticObject.UseVariantDebug)
                    if (!Content.Contains("$_plugin_id " + Variable + ";"))
                        GlobalClass.Alert(Language.GetLanguage("do_not_find_semicolon_in_asp_variant", GlobalLanguage).Replace("$_asp variant;", "$_plugin_id " + Variable + ";"), GlobalLanguage, "problem");
            ...
            while (Content.Contains("$_plugin_name "))
            {
                ...
                if (StaticObject.UseVariantDebug)
                    if (!Content.Contains("$_plugin_name " + Variable + ";"))
                        GlobalClass.Alert(Language.GetLanguage("do_not_find_semicolon_in_asp_variant", GlobalLanguage).Replace("$_asp variant;", "$_plugin_name " + Variable + ";"), GlobalLanguage, "problem");
        ...
        {
            // File Exist Check
            if (!System.IO.File.Exists(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/fetch/" + FetchName + "/fetch.xml")))
            {
                GlobalClass.Alert(Language.GetLanguage("fetch_asp_is_not_existed", GlobalLanguage).Replace("$_asp fetch_name;", FetchName), GlobalLanguage, "problem");
                return "";
            }
            ...
            FetchDocument.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/fetch/" + FetchName + "/fetch.xml"));
            ...
            while (Content.Contains("$_fetch_name "))
            {
                ...
                if (StaticObject.UseVariantDebug)
                    if (!Content.Contains("$_fetch_name " + Variable + ";"))
                        GlobalClass.Alert(Language.GetLanguage("do_not_find_semicolon_in_asp_variant", GlobalLanguage).Replace("$_asp variant;", "$_fetch_name " + Variable + ";"), GlobalLanguage, "problem");
        ...
        public string GetElanat(string ElanatVariant, string GlobalLanguage)
        {
            ...
            {
                GlobalClass.Alert(Language.GetLanguage("elanat_variable_asp_is_not_existed", GlobalLanguage).Replace("$_asp elanat_variable_name;", ElanatVariant), GlobalLanguage, "problem");
                return "";
            }

            switch (SecondElanatVariant)
            {
                case "session": return HttpContext.Current.Session[ElanatVariant.Remove(0, 10)].ToString();
                case "site_template":
                    {
                        string TagPath = null;
                        int Item = 0;
                ...
                case "web_config":
                    {
                        ...
                        List<string> ListValue = StringClass.ExtractFromString(ElanatVariant, "::");
                        TagPath = ListValue[0].Remove(0, 12);
                        Item = int.Parse(ListValue[1].Remove(0, 7));
                        if (ListValue.Count == 3)
                            Attr = ListValue[2].Remove(0, 7);


                        return WebConfig.GetWebConfig(TagPath, Item, Attr);
                    };

                case "cache": return HttpRuntime.Cache[ElanatVariant.Remove(0, 8)].ToString();
                case "server_variable": return HttpContext.Current.Request.ServerVariables[ElanatVariant.Remove(0, 18)].ToString();
                ...
                case "site":
                    {
                        ...
                        {
                            case "host": return HttpContext.Current.Request.Url.Host + "/";
                            case "site_host": return HttpContext.Current.Request.Url.Host + "/site/" + ccoc.SiteSiteGlobalName;
                            case "host_site_path": return HttpContext.Current.Request.Url.Host + StaticObject.SitePath;
            ...
            while (Content.Contains("$_elanat "))
            {
                ...
                if (StaticObject.UseVariantDebug)
                    if (!Content.Contains("$_elanat " + Variable + ";"))
                        GlobalClass.Alert(Language.GetLanguage("do_not_find_semicolon_in_asp_variant", GlobalLanguage).Replace("$_asp variant;", "$_elanat " + Variable + ";"), GlobalLanguage, "problem");
        ...
        public string ReadLanguage(string Content, string GlobalLanguage, bool BreakLanguage = false)
        {
            ...
            doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "language/" + GlobalLanguage + "/handheld.xml"));
            ...
            while (Content.Contains("$_lang "))
            {
                ...
                if (StaticObject.UseVariantDebug)
                    if (!Content.Contains("$_lang " + Variable + ";"))
                        GlobalClass.Alert(Language.GetLanguage("do_not_find_semicolon_in_asp_variant", GlobalLanguage).Replace("$_asp variant;", "$_lang " + Variable + ";"), GlobalLanguage, "problem");
        ...
        public string GetReplacePart(string ReplacePartName, string GlobalLanguage)
        {
            ...
            GlobalClass.Alert(Language.GetLanguage("replace_part_asp_is_not_exist", GlobalLanguage).Replace("$_asp replace_part_name;", ReplacePartName), GlobalLanguage, "problem");
            return "";
        }
            ...
            while (Content.Contains("$_replace "))
            {
                ...
                if (StaticObject.UseVariantDebug)
                    if (!Content.Contains("$_replace " + Variable + ";"))
                        GlobalClass.Alert(Language.GetLanguage("do_not_find_semicolon_in_asp_variant", GlobalLanguage).Replace("$_asp variant;", "$_replace " + Variable + ";"), GlobalLanguage, "problem");
        ...
        public string GetItem(string ItemId, string GlobalLanguage)
        {
            // Set Cache Key
            CacheClass cc = new CacheClass();
            CurrentClientObjectClass ccoc = new CurrentClientObjectClass();
            ...
            while (Content.Contains("$_item_id "))
            {
                ...
                if (StaticObject.UseVariantDebug)
                    if (!Content.Contains("$_item_id " + Variable + ";"))
                        GlobalClass.Alert(Language.GetLanguage("do_not_find_semicolon_in_asp_variant", GlobalLanguage).Replace("$_asp variant;", "$_item_id " + Variable + ";"), GlobalLanguage, "problem");
