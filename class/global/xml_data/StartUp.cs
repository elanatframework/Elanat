...
namespace Elanat.XmlData
{
    public class StartUp
    {
        public void SetTagToList(string TagName, List<string> AttributeName = null, List<string> AttributeValue = null)
        {
            ...
            doc.Load(StaticObject.ServerMapPath(StaticObject.SitePath + "App_Data/start_up_list/start_up.xml"));
            ...
            doc.Save(StaticObject.ServerMapPath(StaticObject.SitePath + "App_Data/start_up_list/start_up.xml"));
        ...
        {
            var Lines = File.OpenText(StaticObject.ServerMapPath(StaticObject.SitePath + "App_Data/start_up_list/start_up.xml"));
            string XmlText = Lines.ReadToEnd();
            Lines.Close();

            XmlText = XmlText.Replace("</start_up_list>", FullTag + Environment.NewLine + "</start_up_list>");

            File.WriteAllText(StaticObject.ServerMapPath(StaticObject.SitePath + "App_Data/start_up_list/start_up.xml"), XmlText);
