...
namespace Elanat.XmlData
{
    public class ScheduledTasks
    {
        ...
        {
            var Lines = File.OpenText(StaticObject.ServerMapPath(StaticObject.SitePath + "App_Data/scheduled_tasks_list/scheduled_tasks.xml"));
            ...
            File.WriteAllText(StaticObject.ServerMapPath(StaticObject.SitePath + "App_Data/scheduled_tasks_list/scheduled_tasks.xml"), XmlText);
