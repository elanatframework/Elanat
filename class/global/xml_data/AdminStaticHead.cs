...
namespace Elanat.XmlData
{
    public class AdminStaticHead
    {
        public void SetTagToList(string TagName, List<string> AttributeName = null, List<string> AttributeValue = null)
        {
            ...
            doc.Save(StaticObject.ServerMapPath(StaticObject.SitePath + "App_Data/head_list/admin/static_head.xml"));
        ...
        {
            var Lines = File.OpenText(StaticObject.ServerMapPath(StaticObject.SitePath + "App_Data/head_list/admin/static_head.xml"));
            string XmlText = Lines.ReadToEnd();
            Lines.Close();

            XmlText = XmlText.Replace("</static_head_list>", FullTag + Environment.NewLine + "</static_head_list>");

            File.WriteAllText(StaticObject.ServerMapPath(StaticObject.SitePath + "App_Data/head_list/admin/static_head.xml"), XmlText);
