...
namespace elanat
{
    public class HashData
    {
        ...
        public int InsertRow(string RowName)
        {
            ...
            CatalogDocument.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "database/" + DataBaseName + "/" + TableName + "/catalog.xml"));
            ...
            var Lines = System.IO.File.ReadAllLines(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "database/" + DataBaseName + "/" + TableName + "/" + TableAttributeKey + ".ini"));
            ...
            // Save name.txt File
            System.IO.File.WriteAllLines(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "database/" + DataBaseName + "/" + TableName + "/" + TableAttributeKey + ".ini"), Lines);
        ...
        public string SelectRowValue(string DataBaseName, string TableName, string Attribute, int LineNumber, int CollisionIndex = 0)
        {
            ...
            var Lines = System.IO.File.ReadAllLines(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "database/" + DataBaseName + "/" + TableName + "/" + Attribute + ".ini"));
        ...
        public void InsertRowValue(string DataBaseName, string TableName, string Attribute, string value, int LineNumber)
        {
            ...
            System.IO.File.WriteAllLines(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "database/" + DataBaseName + "/" + TableName + "/" + Attribute + ".ini"), Lines);
        }
