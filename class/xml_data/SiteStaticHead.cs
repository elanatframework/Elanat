...
namespace elanat.XmlData
{
    public class SiteStaticHead
    {
        public void SetTagToList(string TagName, List<string> AttributeName = null, List<string> AttributeValue = null)
        {
            ...
            doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/head_list/site/static_head.xml"));
            ...
            doc.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/head_list/site/static_head.xml"));
        ...
        {
            var Lines = System.IO.File.OpenText(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/head_list/site/static_head.xml"));
            string XmlText = Lines.ReadToEnd();
            Lines.Close();

            XmlText = XmlText.Replace("</static_head_list>", FullTag + Environment.NewLine + "</static_head_list>");

            System.IO.File.WriteAllText(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/head_list/site/static_head.xml"), XmlText);
