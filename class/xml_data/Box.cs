...
namespace elanat.XmlData
{
    public class Box
    {
        public void SetTagToList(string TagName, List<string> AttributeName = null, List<string> AttributeValue = null)
        {
            ...
            XmlNode NodeList = doc.SelectSingleNode("box_root/box_list");
            ...
            doc.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/box_list/box.xml"));
        ...
        {
            var Lines = System.IO.File.OpenText(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/box_list/box.xml"));
            string XmlText = Lines.ReadToEnd();
            Lines.Close();

            XmlText = XmlText.Replace("</box_list>", FullTag + Environment.NewLine + "</box_list>");

            System.IO.File.WriteAllText(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/box_list/box.xml"), XmlText);
