...
namespace Elanat
{
    public partial class ActionEditComponentController : CodeBehindController
    {
        public ActionEditComponentModel model = new ActionEditComponentModel();

        public void PageLoad(HttpContext context)
        {
            if (!string.IsNullOrEmpty(context.Request.Form["btn_SaveComponent"]))
            {
                btn_SaveComponent_Click(context);
                return;
            }

            if (string.IsNullOrEmpty(context.Request.Form["hdn_ComponentId"]))
            {
        ...
        protected void btn_SaveComponent_Click(HttpContext context)
        {
            ...
            model.ComponentIdValue = context.Request.Form["hdn_ComponentId"];
