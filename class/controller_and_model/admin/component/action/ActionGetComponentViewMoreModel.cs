...
namespace Elanat
{
    public partial class ActionGetComponentViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string ComponentId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/component/");
