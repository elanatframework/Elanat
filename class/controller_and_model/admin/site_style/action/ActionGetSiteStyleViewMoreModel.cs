...
namespace Elanat
{
    public partial class ActionGetSiteStyleViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string SiteStyleId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/site_style/");
