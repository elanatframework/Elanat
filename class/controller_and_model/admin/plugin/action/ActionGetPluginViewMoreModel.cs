...
namespace Elanat
{
    public partial class ActionGetPluginViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string PluginId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/plugin/");
