...
namespace Elanat
{
    public partial class ActionGetExtraHelperViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string ExtraHelperId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/extra_helper/");
