...
namespace Elanat
{
    public partial class ActionGetContactViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string ContactId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/contact/");
