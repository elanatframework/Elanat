...
namespace Elanat
{
    public partial class ActionGetSiteViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string SiteId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/site/");
