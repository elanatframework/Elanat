...
namespace Elanat
{
    public partial class ActionEditModuleController : CodeBehindController
    {
        public ActionEditModuleModel model = new ActionEditModuleModel();

        public void PageLoad(HttpContext context)
        {
            if (!string.IsNullOrEmpty(context.Request.Form["btn_SaveModule"]))
            {
                btn_SaveModule_Click(context);
                return;
            }

            if (string.IsNullOrEmpty(context.Request.Form["hdn_ModuleId"]))
            {
        ...
        protected void btn_SaveModule_Click(HttpContext context)
        {
            ...
            model.ModuleIdValue = context.Request.Form["hdn_ModuleId"];
