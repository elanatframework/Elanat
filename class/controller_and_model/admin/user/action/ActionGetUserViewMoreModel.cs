...
namespace Elanat
{
    public partial class ActionGetUserViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string UserId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/user/");
