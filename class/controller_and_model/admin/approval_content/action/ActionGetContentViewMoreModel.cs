...
namespace Elanat
{
    public partial class ActionGetInactiveContentViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string ContentId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/approval_content/");
