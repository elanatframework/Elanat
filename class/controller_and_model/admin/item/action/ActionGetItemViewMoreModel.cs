...
namespace Elanat
{
    public partial class ActionGetItemViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string ItemId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/item/");
