...
namespace Elanat
{
    public partial class ActionGetPatchViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string PatchId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/patch/");
