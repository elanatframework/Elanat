...
namespace Elanat
{
    public partial class ActionGetRoleViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string RoleId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/role/");
