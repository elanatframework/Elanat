...
namespace Elanat
{
    public partial class ActionGetSiteTemplateViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string SiteTemplateId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/site_template/");
