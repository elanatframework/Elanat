...
namespace Elanat
{
    public partial class ActionDeleteInactiveContentController : CodeBehindController
    {
        public void PageLoad(HttpContext context)
        {
            ...
            if (pc.IsProtected(context.Request.Query["content_id"].ToString(), StaticObject.AdminPath + "/content/"))
            {
                Write("false");
                return;
            }
