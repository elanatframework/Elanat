...
namespace Elanat
{
    public partial class ActionInactiveCommentController : CodeBehindController
    {
        public void PageLoad(HttpContext context)
        {
            ...
            duc.Inactive(context.Request.Query["comment_id"].ToString());
            Write("true");
				
				
			// Add Reference
			ReferenceClass rc = new ReferenceClass();
			rc.StartEvent("inactive_comment", context.Request.Query["comment_id"].ToString());
        }
    }
}