...
namespace Elanat
{
    public partial class ActionDeleteTrashContentController : CodeBehindController
    {
        public void PageLoad(HttpContext context)
        {
            ...
            if (pc.IsProtected(context.Request.Query["content_id"].ToString(), StaticObject.AdminPath + "/recycle_bin/"))
            {
                Write("false");
                return;
            }
