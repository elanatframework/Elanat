...
namespace Elanat
{
    public partial class ActionGetTrashContentViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string ContentId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/recycle_bin/");
