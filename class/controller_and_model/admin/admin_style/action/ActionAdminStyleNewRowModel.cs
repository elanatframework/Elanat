...
namespace Elanat
{
    public partial class ActionAdminStyleNewRowModel : CodeBehindModel
    {
        ...
        public void SetValue()
        {
            ...
            TmpRowBoxTemplate = TmpRowBoxTemplate.Replace("$_asp admin_style_extension_name;", Path.GetExtension(duas.ReturnDr["admin_style_physical_path"].ToString()).Remove(0, 1));
