...
namespace Elanat
{
    public partial class ActionChangeViewModel : CodeBehindModel
    {
        ...
        {
            new HttpContextAccessor().HttpContext.Response.Redirect(StaticObject.AdminPath + "/profile/action/change_view/action/SuccessMessage.aspx", true);
        }
    }
}