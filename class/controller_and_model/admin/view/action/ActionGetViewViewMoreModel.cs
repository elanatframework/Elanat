...
namespace Elanat
{
    public partial class ActionGetViewViewMoreModel : CodeBehindModel
    {
        public string GetViewMore(string ViewId)
        {
            ...
            {
                dbdr.dr.Read();
                List<string> ViewMoreList = GlobalClass.GetItemViewMoreList(StaticObject.AdminPath + "/view/");
