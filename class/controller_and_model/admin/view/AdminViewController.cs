...
namespace Elanat
{
    public partial class AdminViewController : CodeBehindController
    {
        public AdminViewModel model = new AdminViewModel();

        public void PageLoad(HttpContext context)
        {
            if (!string.IsNullOrEmpty(context.Request.Form["btn_AddView"]))
            {
                btn_AddView_Click(context);
                return;
            }
        ...
        protected void btn_AddView_Click(HttpContext context)
        {
