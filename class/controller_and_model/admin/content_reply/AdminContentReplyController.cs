...
namespace Elanat
{
    public partial class AdminContentReplyController : CodeBehindController
    {
        ...
        public void PageLoad(HttpContext context)
        {
            ...
            if (!string.IsNullOrEmpty(context.Request.Form["btn_AddContentReply"]))
            {
                btn_AddContentReply_Click(context);
                return;
            }
        ...
        protected void btn_AddContentReply_Click(HttpContext context)
        {
