...
namespace Elanat
{
    public partial class SiteContentReplyZipCodeModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            ZipCodeLanguage = Language.GetAddOnsLanguage("zip_code", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/content_reply/");
        }
