...
namespace Elanat
{
    public partial class SiteContentReplyAddressModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            AddressLanguage = Language.GetAddOnsLanguage("address", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/content_reply/");
        }
