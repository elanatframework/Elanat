...
namespace Elanat
{
    public partial class SiteContentReplyStateOrProvinceModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            StateOrProvinceLanguage = Language.GetAddOnsLanguage("state_or_province", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/content_reply/");
        }
