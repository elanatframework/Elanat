...
namespace Elanat
{
    public partial class SiteContentReplyBirthdayModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            BirthdayLanguage = Language.GetAddOnsLanguage("birthday", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/content_reply/");
