...
namespace Elanat
{
    public partial class SiteContentReplyPostalCodeModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            PostalCodeLanguage = Language.GetAddOnsLanguage("postal_code", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/content_reply/");
        }
