...
namespace Elanat
{
    public partial class SiteSignUpBirthdayModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            BirthdayLanguage = Language.GetAddOnsLanguage("birthday", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/sign_up/");
