...
namespace Elanat
{
    public partial class SiteSignUpCityModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            CityLanguage = Language.GetAddOnsLanguage("city", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/sign_up/");
        }
