...
namespace Elanat
{
    public partial class SiteSignUpAddressModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            AddressLanguage = Language.GetAddOnsLanguage("address", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/sign_up/");
        }
