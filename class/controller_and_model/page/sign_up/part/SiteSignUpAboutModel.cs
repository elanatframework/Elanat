...
namespace Elanat
{
    public partial class SiteSignUpAboutModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            AboutLanguage = Language.GetAddOnsLanguage("about", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/sign_up/");
        }
