...
namespace Elanat
{
    public partial class SiteSignUpMobileNumberModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            MobileNumberLanguage = Language.GetAddOnsLanguage("mobile_number", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/sign_up/");
        }
