...
namespace Elanat
{
    public partial class SiteSignUpCountryModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            CountryLanguage = Language.GetAddOnsLanguage("country", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/sign_up/");
        }
