...
namespace Elanat
{
    public partial class MemberChangeProfileModel : CodeBehindModel
    {
        ...
        {
            new HttpContextAccessor().HttpContext.Response.Redirect(StaticObject.SitePath + "page/member/change_profile/action/SuccessMessage.aspx?use_retrieved=true", true);
        }
    }
}