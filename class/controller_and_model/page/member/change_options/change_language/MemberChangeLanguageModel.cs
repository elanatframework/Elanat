...
namespace Elanat
{
    public partial class MemberChangeLanguageModel : CodeBehindModel
    {
        ...
        public void SetValue()
        {
            ...
            AdminLanguageOptionListValue += lcl.LanguageListItem.HtmlInputToOptionTag(AdminLanguageOptionListSelectedValue);
        }
        ...
        {
            new HttpContextAccessor().HttpContext.Response.Redirect(StaticObject.SitePath + "page/member/change_options/change_language/action/SuccessMessage.aspx?use_retrieved=true", true);
        }
    }
}