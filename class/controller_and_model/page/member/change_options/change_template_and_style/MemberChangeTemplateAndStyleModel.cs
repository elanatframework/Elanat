...
namespace Elanat
{
    public partial class MemberChangeTemplateAndStyleModel : CodeBehindModel
    {
        ...
        public void SetValue()
        {
            ...
            SiteStyleOptionListValue += lcss.SiteStyleListItem.HtmlInputToOptionTag(SiteStyleOptionListSelectedValue);
            ...
            SiteTemplateOptionListValue += lcst.SiteTemplateListItem.HtmlInputToOptionTag(SiteTemplateOptionListSelectedValue);
            ...
            AdminStyleOptionListValue += lcas.AdminStyleListItem.HtmlInputToOptionTag(AdminStyleOptionListSelectedValue);
            ...
            AdminTemplateOptionListValue += lcat.AdminTemplateListItem.HtmlInputToOptionTag(AdminTemplateOptionListSelectedValue);
        }
        ...
        {
            new HttpContextAccessor().HttpContext.Response.Redirect(StaticObject.SitePath + "page/member/change_options/change_template_and_style/action/SuccessMessage.aspx?use_retrieved=true", true);
        }
    }
}