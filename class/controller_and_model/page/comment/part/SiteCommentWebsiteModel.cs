...
namespace Elanat
{
    public partial class SiteCommentWebsiteModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            WebsiteLanguage = Language.GetAddOnsLanguage("website", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/comment/");
        }
