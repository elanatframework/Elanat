...
namespace Elanat
{
    public partial class SiteCommentPublicEmailModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            PublicEmailLanguage = Language.GetAddOnsLanguage("public_email", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/comment/");
        }
