...
namespace Elanat
{
    public partial class SiteCommentTextModel : CodeBehindModel
    {
        ...
        {
            // Set Language
            TextLanguage = Language.GetAddOnsLanguage("text", StaticObject.GetCurrentSiteGlobalLanguage(), StaticObject.SitePath + "page/comment/");
        }
