...
namespace Elanat
{
    public partial class IncludeHijriCalendarModel : CodeBehindModel
    {
        ...
        public void SetValue(string CurrentDate = "")
        {
            ...
            // Set Mount Value
            lcdat.FillHijriMountListItemByCalendarLanguage(StaticObject.GetCurrentSiteGlobalLanguage());
            string CurrentMount = hc.GetMonth(dt).ToString();

            foreach (ListItem Mount in lcdat.HijriMountListItemByCalendarLanguage)
            {
