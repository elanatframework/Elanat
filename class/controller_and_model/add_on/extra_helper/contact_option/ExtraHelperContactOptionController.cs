...
namespace Elanat
{
    public partial class ExtraHelperContactOptionController : CodeBehindController
    {
        public ExtraHelperContactOptionModel model = new ExtraHelperContactOptionModel();

        public void PageLoad(HttpContext context)
        {
            if (!string.IsNullOrEmpty(context.Request.Form["btn_SaveContactOption"]))
            {
                btn_SaveContactOption_Click(context);
                return;
            }
        ...
        protected void btn_SaveContactOption_Click(HttpContext context)
        {
