...
namespace Elanat
{
    public partial class ExtraHelperCommentOptionModel : CodeBehindModel
    {
        ...
        public void SaveCommentOption()
        {
            ...
            CommentOptionDocument.Save(StaticObject.ServerMapPath(StaticObject.SitePath + "add_on/extra_helper/comment_option/option/comment_option.xml"));
