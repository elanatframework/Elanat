...
namespace elanat.DataUse
{
    public class Language : IDisposable
    {
        ...
        public void Delete(string LanguageId)
        {
            ...
            System.IO.Directory.Delete(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "language/" + dul.LanguageGlobalName + "/"), true);
        }
        ...
        public NameValueCollection GetActiveLanguageGlobalNameNumber()
        {
            DataBaseSocket db = new DataBaseSocket();
            DataBaseDataReader dbdr = new DataBaseDataReader();
            ...
            NameValueCollection LanguageGlobalNameNumber = new NameValueCollection();
        ...
        public List<XmlDocument> SetLanguageGlobalNameDocumentList(NameValueCollection LanguageGlobalNameNumber)
        {
            List<XmlDocument> LanguageGlobalNameDocumentList = new List<XmlDocument>();

            foreach (string text in LanguageGlobalNameNumber)
            {
                XmlDocument doc = new XmlDocument();
                doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "language/" + text + "/" + text + ".xml"));
        ...
        public List<XmlDocument> SetHandheldLanguageGlobalNameDocumentList(NameValueCollection LanguageGlobalNameNumber)
        {
            ...
            {
                XmlDocument doc = new XmlDocument();
                doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "language/" + text + "/handheld.xml"));
