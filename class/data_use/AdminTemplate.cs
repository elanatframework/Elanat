    ...
    public class AdminTemplate : IDisposable
    {
        ...
        public void Delete(string AdminTemplateId)
        {
            ...
            while (ParentDirectoryList.Count >= 1)
            {
                ...
                System.IO.Directory.Delete(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "template/admin/" + TmpPath + "/"), IsLastDirectory);
        ...
        public List<XmlDocument> SetTemplatePhysicalPathDocumentList(NameValueCollection TemplatePhysicalPathNameNumber)
        {
            ...
            foreach (string text in TemplatePhysicalPathNameNumber)
            {
                ...
                doc.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "template/admin/" + text));
