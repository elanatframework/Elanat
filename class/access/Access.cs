...
namespace elanat
{
	public class Access
	{
        ...
        {
            XmlNodeList NodeList = StaticObject.RoleAllwoPathAccessNodeList[StaticObject.RoleNameNumber[RoleName].ToNumber()];
        ...
        {
            XmlNodeList NodeList = StaticObject.RoleDenyPathAccessNodeList[StaticObject.RoleNameNumber[RoleName].ToNumber()];
        ...
        public bool ProcedureRoleAccessCheck(string ProcedureName)
        {
            ...
            foreach (string Text in ccoc.GetRoleNameList())
            {
                ...
                XmlNodeList NodeList = StaticObject.RoleProcedureFilterNodeList[StaticObject.RoleNameNumber[Text].ToNumber()];
