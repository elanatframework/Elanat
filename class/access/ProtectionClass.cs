...
namespace elanat
{
	public class ProtectionClass
    {
        ...
        {
            if (!System.IO.File.Exists(HttpContext.Current.Server.MapPath(Path + "App_Data/protection_list/protection.xml")))
                return false;


            XmlDocument doc = new XmlDocument();
            doc.Load(HttpContext.Current.Server.MapPath(Path + "App_Data/protection_list/protection.xml"));
