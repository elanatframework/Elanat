        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (string key in (StaticObject.SiteMainCacheParameters.Split(',')))
                if (!string.IsNullOrEmpty(QueryStringCollection[key]))
                    SiteMainCacheKey += ":" + QueryStringCollection[key].ToString();
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["language"]))
            {
                ...
                {
                    HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/language_is_not_existed");
                    return;
                }

                if (!dul.LanguageActive.ZeroOneToBoolean())
                {
                    HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/language_is_inactive");
                    return;
                }
            ...
            {
                HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/site_is_not_existed");
                return;
            }

            if (!dus.SiteActive.ZeroOneToBoolean())
            {
                HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/site_is_inactive");
                return;
            }
            ...
            if (!dus.SitePublicAccessShow.ZeroOneToBoolean())
                ...
                {
                    HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/you_do_not_access_to_site");
                    return;
                }
            ...
            if (!PriorityLanguage)
            {
                ...
                if (!dul.LanguageActive.ZeroOneToBoolean())
                {
                    Response.Write(Template.GetSiteTemplate("part/role_access/view").Replace("$_asp inaccess_reason;", Language.GetLanguage("site_style_is_inactive", CurrentLanguageGlobalName)));
                    return;
                }
            }
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["page_content"]))
            {
                CurrentPageGlobalName = Request.QueryString["page_content"].ProtectSqlInjection();
            ...
            {
                HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/page_is_not_existed");
                return;
            }

            if (!dup.PageActive.ZeroOneToBoolean())
            {
                HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/page_is_inactive");
                return;
            }
            ...
            if (StaticObject.GetCurrentUserId() != "0")
            {
                ...
                {
                    HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/user_is_not_existed");
                    return;
                }

                if (!duu.UserActive.ZeroOneToBoolean())
                {
                    HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/" + Language.GetLanguage("user_is_inactive", CurrentLanguageGlobalName));
                    return;
                }
            ...
            string ViewId = duv.GetViewIdByQueryString(Request.QueryString.ToString());
            ...
            {
                HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/site_template_is_not_existed");
                return;
            }

            if (!dust.SiteTemplateActive.ZeroOneToBoolean())
            {
                HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/site_template_is_inactive");
                return;
            }
            ...
            {
                HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/site_style_is_not_existed");
                return;
            }

            if (!duss.SiteStyleActive.ZeroOneToBoolean())
            {
                HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/error/site_style_is_inactive");
                return;
            }
            ...
            if (dup.PageLoadAlone.ZeroOneToBoolean())
            {
                if (dup.PageUseHtml.ZeroOneToBoolean())
                {
                    ...
                    CurrentPageContent = chfpp.GetValue(dup.PageId, Request.QueryString);
                }
                else
            ...
            if (dup.PageGlobalName == "main")
                ...
                {
                    string TagName = Request.QueryString["tag"].ToString().Replace("_", " ");
            ...
            {
                CurrentTitle += " - " + Language.GetLanguage("page", CurrentLanguageGlobalName) + " " + Request.QueryString["page"].ToString();
            }
            ...
            {
                Response.Clear();
                Response.Write(CurrentPageContent);
                Response.End();
