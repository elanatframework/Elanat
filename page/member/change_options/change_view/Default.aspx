<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="elanat.MemberChangeView" %>
<div id="div_ChangeViewPostBack">

    <div class="el_head">
        <%=model.MemberLanguage%>
    </div>

    <form id="frm_MemberChangeView" method="post" action="<%=elanat.AspxHtmlValue.SitePath()%>page/member/change_options/change_view/Default.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_ChangeView" name="btn_ChangeView" type="submit" class="el_button_input" value="<%=model.ChangeViewLanguage%>" onclick="el_AjaxPostBack(this, false, 'frm_MemberChangeView')" />
            </div>
        </div>
