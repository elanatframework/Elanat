...
namespace elanat
{
    public class MemberChangeDateAndTimeModel
    {
        ...
        public void SetValue()
        {
            ...
            // Set Calendar Item
            lc.FillCalendarListItem(StaticObject.GetCurrentSiteGlobalLanguage());
            CalendarOptionListValue += CalendarOptionListValue.HtmlInputAddOptionTag("", "");
            CalendarOptionListValue += lc.CalendarListItem.HtmlInputToOptionTag(CalendarOptionListSelectedValue);

            // Set Day Of Weak Item
            lc.FillDayOfWeakListItem(StaticObject.GetCurrentSiteGlobalLanguage());
            ...
            // Set Time Zone Item
            lc.FillTimeZoneListItem(StaticObject.GetCurrentSiteGlobalLanguage());
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/member/change_options/change_date_and_time/action/SuccessMessage.aspx?use_retrieved=true", true);
        }
    }
}