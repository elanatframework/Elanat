...
namespace elanat
{
    public class SiteSignUpModel
    {
        ...
        public void SetImportantField()
        {
            ...
            PasswordAttribute += vc.ImportantInputAttribute["txt_Password"];
            RepeatPasswordAttribute += vc.ImportantInputAttribute["txt_RepeatPassword"];

            PasswordCssClass = PasswordCssClass.AddHtmlClass(vc.ImportantInputClass["txt_Password"]);
        ...
        public void EvaluateField(NameValueCollection FormData)
        {
            ...
            if (!vc.TrueContinue)
            {
                ...
                //PasswordCssClass = PasswordCssClass.AddHtmlClass(vc.WarningFieldClass["txt_Password"]);
        ...
        public void SignUp()
        {
            ...
            if (UseAvatarPathValue)
            {
                ...
                DirectoryName = FileAndDirectory.GetNewDirectoryNameIfDirectoryExist(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/"), Path.GetFileNameWithoutExtension(AvatarFilePhysicalName));

                System.IO.Directory.CreateDirectory(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName));
                webClient.DownloadFile(AvatarPathTextValue, HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + AvatarFilePhysicalName));
            }
            else
            {
                if (AvatarPathUploadValue.HtmlInputHasFile())
                {
                    ...
                    System.IO.Directory.CreateDirectory(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName));
                    AvatarPathUploadValue.SaveAs(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + AvatarFilePhysicalName));
                }
            }
            ...
            if (UseAvatarPathValue || AvatarPathUploadValue.HtmlInputHasFile())
            {
                ...
                double FileSize = new FileInfo(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + AvatarFilePhysicalName)).Length;
            ...
            if (UseAvatarPathValue || AvatarPathUploadValue.HtmlInputHasFile())
            {
                ...
                fad.ConvertImageToPngFormat(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + AvatarFilePhysicalName), HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + AvatarFilePhysicalName + ".tmp"));

                File.Move(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + AvatarFilePhysicalName + ".tmp"), HttpContext.Current.Server.MapPath(StaticObject.SitePath + "client/image/user_avatar/" + duu.UserId + ".png"));
        ...
        public void SuccessView()
        {
            ...
            HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/sign_up/action/SuccessMessage.aspx?use_retrieved=true" + ReturnUrlValue, true);
        }
    }
}