...
namespace elanat
{
    public class SiteCommentTypeModel
    {
        ...
        public void SetValue()
        {
            ...
            // Set Type Item
            lc.FillCommentTypeListItem(StaticObject.GetCurrentSiteGlobalLanguage());
            TypeOptionListValue += lc.CommentTypeListItem.HtmlInputToOptionTag(TypeOptionListSelectedValue);
