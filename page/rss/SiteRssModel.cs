        ...
        public void SetValue()
        {
            ...
            if (ActiveCategoryFeed)
            {
                ...
                foreach (ListItem item in lc.CategoryListItemTree)
                {
                    ...
                    TmpRssCategoryListItemTemplate = TmpRssCategoryListItemTemplate.Replace("$_asp category_name;", lc.CategoryListItemOnlySpace[CategoryIndexer].Text + Language.GetHandheldLanguage(lc.CategoryListItemTreeWithoutSpace[CategoryIndexer].Text, StaticObject.GetCurrentSiteGlobalLanguage()));
            ...
            HttpContext.Current.Response.Write(RssBoxTemplate.Replace("$_asp item;", SumRssListItemTemplate));
        }
    }
}