...
namespace elanat
{
    public class SiteContentReplyContentReplyBoxModel
    {
        public string SendContentReplyLanguage { get; set; }
        ...
        public void SetValue()
        {
            ...
            SendContentReplyLanguage = aol.GetAddOnsLanguage("send_content_reply");
            ...
            if (node["about"].Attributes["active"].Value == "true")
                AboutPartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyAbout.aspx?about_value=" + AboutValue + "&about_css_class=" + AboutCssClass + "&about_attribute=" + AboutAttribute);

            if (node["address"].Attributes["active"].Value == "true")
                AddressPartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyAddress.aspx?address_value=" + AddressValue + "&address_css_class=" + AddressCssClass + "&address_attribute=" + AddressAttribute);

            if (node["birthday"].Attributes["active"].Value == "true")
                BirthdayPartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyBirthday.aspx?birthday_year_value=" + BirthdayYearOptionListSelectedValue + "&birthday_mount_value=" + BirthdayMountOptionListSelectedValue + "&birthday_day_value=" + BirthdayDayOptionListSelectedValue + "&birthday_year_css_class=" + BirthdayYearCssClass + "&birthday_mount_css_class=" + BirthdayMountCssClass + "&birthday_day_css_class=" + BirthdayDayCssClass + "&birthday_year_attribute=" + BirthdayYearAttribute + "&birthday_mount_attribute=" + BirthdayMountAttribute + "&birthday_day_attribute=" + BirthdayDayAttribute);

            if (node["email"].Attributes["active"].Value == "true")
                EmailPartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyEmail.aspx?email_value=" + EmailValue + "&email_css_class=" + EmailCssClass + "&email_attribute=" + EmailAttribute);

            if (node["type"].Attributes["active"].Value == "true")
                TypePartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyType.aspx?type_value=" + TypeOptionListSelectedValue + "&email_css_class=" + TypeCssClass + "&content_reply_type=" + ContentReplyTypeValue);

            if (node["gender"].Attributes["active"].Value == "true")
                GenderPartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyGender.aspx?gender_checked=" + ((GenderFemaleValue) ? "female" : (GenderMaleValue) ? "male" : "unknown") + "&gender_unknown_attribute=" + GenderUnknownAttribute + "&gender_male_attribute=" + GenderMaleAttribute + "&gender_female_attribute=" + GenderFemaleAttribute);

            if (node["phone_number"].Attributes["active"].Value == "true")
                PhoneNumberPartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyPhoneNumber.aspx?phone_number_value=" + PhoneNumberValue + "&phone_number_css_class=" + PhoneNumberCssClass + "&phone_number_attribute=" + PhoneNumberAttribute);

            if (node["mobile_number"].Attributes["active"].Value == "true")
                MobileNumberPartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyMobileNumber.aspx?mobile_number_value=" + MobileNumberValue + "&mobile_number_css_class=" + MobileNumberCssClass + "&mobile_number_attribute=" + MobileNumberAttribute);

            if (node["postal_code"].Attributes["active"].Value == "true")
                PostalCodePartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyPostalCode.aspx?postal_code_value=" + PostalCodeValue + "&postal_code_css_class=" + PostalCodeCssClass + "&postal_code_attribute=" + PostalCodeAttribute);

            if (node["text"].Attributes["active"].Value == "true")
                TextPartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyText.aspx?text_value=" + TextValue + "&text_css_class=" + TextCssClass);

            if (node["name"].Attributes["active"].Value == "true")
                RealNamePartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyRealName.aspx?real_name_value=" + RealNameValue + "&real_name_css_class=" + RealNameCssClass + "&real_name_attribute=" + RealNameAttribute);

            if (node["last_name"].Attributes["active"].Value == "true")
                RealLastNamePartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyRealLastName.aspx?real_last_name_value=" + RealLastNameValue + "&real_last_name_css_class=" + RealLastNameCssClass + "&real_last_name_attribute=" + RealLastNameAttribute);

            if (node["website"].Attributes["active"].Value == "true")
                WebsitePartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyWebsite.aspx?website_value=" + WebsiteValue + "&website_css_class=" + WebsiteCssClass + "&website_attribute=" + WebsiteAttribute);

            if (node["public_email"].Attributes["active"].Value == "true")
                PublicEmailPartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyPublicEmail.aspx?public_email_value=" + PublicEmailValue + "&public_email_css_class=" + PublicEmailCssClass + "&public_email_attribute=" + PublicEmailAttribute);

            if (node["country"].Attributes["active"].Value == "true")
                CountryPartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyCountry.aspx?country_value=" + CountryValue + "&country_css_class=" + CountryCssClass + "&country_attribute=" + CountryAttribute);

            if (node["state_or_province"].Attributes["active"].Value == "true")
                StateOrProvincePartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyStateOrProvince.aspx?state_or_province_value=" + StateOrProvinceValue + "&state_or_province_css_class=" + StateOrProvinceCssClass + "&state_or_province_attribute=" + StateOrProvinceAttribute);

            if (node["city"].Attributes["active"].Value == "true")
                CityPartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyCity.aspx?city_value=" + CityValue + "&city_css_class=" + CityCssClass + "&city_attribute=" + CityAttribute);

            if (node["zip_code"].Attributes["active"].Value == "true")
                ZipCodePartValue = PageLoader.LoadWithServer(StaticObject.SitePath + "page/content_reply/part/SiteContentReplyZipCode.aspx?zip_code_value=" + ZipCodeValue + "&zip_code_css_class=" + ZipCodeCssClass + "&zip_code_attribute=" + ZipCodeAttribute);
        }
        ...
        public void EvaluateField(NameValueCollection FormData)
        {
            ...
            if (!vc.TrueContinue)
            {
                ...
                //AboutCssClass = AboutCssClass.AddHtmlClass(vc.WarningFieldClass["txt_About"]);
                //AddressCssClass = AddressCssClass.AddHtmlClass(vc.WarningFieldClass["txt_Address"]);
                //CityCssClass = CityCssClass.AddHtmlClass(vc.WarningFieldClass["txt_City"]);
                //CountryCssClass = CountryCssClass.AddHtmlClass(vc.WarningFieldClass["txt_Country"]);
                //EmailCssClass = EmailCssClass.AddHtmlClass(vc.WarningFieldClass["txt_Email"]);
                //MobileNumberCssClass = MobileNumberCssClass.AddHtmlClass(vc.WarningFieldClass["txt_PhoneNumber"]);
                //PhoneNumberCssClass = PhoneNumberCssClass.AddHtmlClass(vc.WarningFieldClass["txt_PhoneNumber"]);
                //PostalCodeCssClass = PostalCodeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_PostalCode"]);
                //PublicEmailCssClass = PublicEmailCssClass.AddHtmlClass(vc.WarningFieldClass["txt_PublicEmail"]);
                //TextCssClass = TextCssClass.AddHtmlClass(vc.WarningFieldClass["txt_Text"]);
                //RealNameCssClass = RealNameCssClass.AddHtmlClass(vc.WarningFieldClass["txt_RealName"]);
                //RealLastNameCssClass = RealLastNameCssClass.AddHtmlClass(vc.WarningFieldClass["txt_RealLastName"]);
                //StateOrProvinceCssClass = StateOrProvinceCssClass.AddHtmlClass(vc.WarningFieldClass["txt_StateOrProvince"]);
                //WebsiteCssClass = WebsiteCssClass.AddHtmlClass(vc.WarningFieldClass["txt_Website"]);
                //ZipCodeCssClass = ZipCodeCssClass.AddHtmlClass(vc.WarningFieldClass["txt_ZipCode"]);
                //TypeCssClass = TypeCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_Type"]);
                //BirthdayYearCssClass = BirthdayYearCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_BirthdayYear"]);
                //BirthdayMountCssClass = BirthdayMountCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_BirthdayYeaBirthdayMount"]);
                //BirthdayDayCssClass = BirthdayDayCssClass.AddHtmlClass(vc.WarningFieldClass["ddlst_BirthdayDay"]);
            }
        }
    }
}