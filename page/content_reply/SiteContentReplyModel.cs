...
namespace elanat
{
    public class SiteContentReplyModel
    {
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/content_reply/action/SuccessMessage.aspx?use_retrieved=true");
        }
    }
}