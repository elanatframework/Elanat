    ...
    public class SiteContactModel
    {
        ...
        public void EvaluateField(NameValueCollection FormData)
        {
            ...
            if (!vc.TrueContinue)
            {
                ...
                //TitleCssClass = TitleCssClass.AddHtmlClass(vc.WarningFieldClass["txt_Title"]);
        ...
        public void SendContact()
        {
            ...
            if (UseUploadPathValue || UploadPathUploadValue.HtmlInputHasFile())
            {
                if (!Directory.Exists(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/contact/" + DirectoryName)))
                    Directory.CreateDirectory(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/contact/" + DirectoryName));

                File.Move(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "App_Data/tmp/" + DirectoryName + "/" + UploadFilePhysicalName), HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/contact/" + DirectoryName + "/" + UploadFilePhysicalName));
                ...
                if (FileAndDirectory.IsImageExtension(FileExtension))
                    ...
                    {
                        if (!System.IO.Directory.Exists(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/contact/" + DirectoryName + "/thumb/")))
                            System.IO.Directory.CreateDirectory(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "upload/contact/" + DirectoryName + "/thumb/"));
        ...
        {
            HttpContext.Current.Response.Redirect(StaticObject.SitePath + "page/contact/action/SuccessMessage.aspx?response_code=" + ResponseCodeValue);
        }
    }
}