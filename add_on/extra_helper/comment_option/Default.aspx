<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="elanat.ExtraHelperCommentOption" %><!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml" dir="<%=elanat.AspxHtmlValue.CurrentAdminLanguageDirection()%>">
<head>
    <title><%=model.CommentOptionLanguage%></title>
...
<body onload="el_PartPageLoad();">
    ...
    <div class="el_head">
        <%=model.CommentOptionLanguage%>
    </div>

    <form id="frm_ExtraHelperCommentOption" method="post" action="<%=elanat.AspxHtmlValue.SitePath()%>add_on/extra_helper/comment_option/Default.aspx">
        ...
        <div class="el_part_row">
            ...
            <div class="el_item">
                <input id="btn_SaveCommentOption" name="btn_SaveCommentOption" type="submit" class="el_button_input" value="<%=model.SaveCommentOptionLanguage%>" onclick="el_AjaxPostBack(this)" />
            </div>
        </div>
