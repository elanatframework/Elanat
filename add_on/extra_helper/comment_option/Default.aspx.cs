...
namespace elanat
{
    public partial class ExtraHelperCommentOption : System.Web.UI.Page
    {
        public ExtraHelperCommentOptionModel model = new ExtraHelperCommentOptionModel();

        protected void Page_Load(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(Request.Form["btn_SaveCommentOption"]))
                btn_SaveCommentOption_Click(sender, e);


            model.SetValue();
        }

        protected void btn_SaveCommentOption_Click(object sender, EventArgs e)
        {
