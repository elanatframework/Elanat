...
namespace elanat
{
    public class ExtraHelperSitemapOptionModel
    {
        ...
        public void SaveSitemapOption()
        {
            ...
            SitemapOptionDocument.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/extra_helper/sitemap_option/option/sitemap_option.xml"));
            ...
            GlobalClass.AlertAddOnsLanguageVariant("sitemap_option_was_save", StaticObject.GetCurrentAdminGlobalLanguage(), "success", StaticObject.SitePath + "add_on/extra_helper/sitemap_option/");
        }
    }
}