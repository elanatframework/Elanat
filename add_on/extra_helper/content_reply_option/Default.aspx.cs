...
namespace elanat
{
    public partial class ExtraHelperContentReplyOption : System.Web.UI.Page
    {
        public ExtraHelperContentReplyOptionModel model = new ExtraHelperContentReplyOptionModel();

        protected void Page_Load(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(Request.Form["btn_SaveContentReplyOption"]))
                btn_SaveContentReplyOption_Click(sender, e);


            model.SetValue();
        }

        protected void btn_SaveContentReplyOption_Click(object sender, EventArgs e)
        {
