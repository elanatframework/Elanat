...
namespace elanat
{
    public class ExtraHelperContentReplyOptionModel
    {
        // Set Language
        ...
        public void SaveContentReplyOption()
        {
            ...
            ContentReplyOptionDocument.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/extra_helper/content_reply_option/option/content_reply_option.xml"));
