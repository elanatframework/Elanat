...
namespace elanat
{
    public class ExtraHelperContactOptionModel
    {
        ...
        public void SaveContactOption()
        {
            ...
            ContactOptionDocument.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/extra_helper/contact_option/option/contact_option.xml"));
