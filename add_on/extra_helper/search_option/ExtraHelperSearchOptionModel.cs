...
namespace elanat
{
    public class ExtraHelperSearchOptionModel
    {
        ...
        public void SetImportantField()
        {
            ...
            MinimumSearchCharacterAttribute += vc.ImportantInputAttribute["txt_MinimumSearchCharacter"];
            SearchedPerPageAttribute += vc.ImportantInputAttribute["txt_SearchedPerPage"];
            NextSearchDelayAttribute += vc.ImportantInputAttribute["txt_NextSearchDelay"];

            MinimumSearchCharacterCssClass = MinimumSearchCharacterCssClass.AddHtmlClass(vc.ImportantInputClass["txt_MinimumSearchCharacter"]);
            SearchedPerPageCssClass = SearchedPerPageCssClass.AddHtmlClass(vc.ImportantInputClass["txt_SearchedPerPage"]);
            NextSearchDelayhCssClass = NextSearchDelayhCssClass.AddHtmlClass(vc.ImportantInputClass["txt_NextSearchDelay"]);
        }
        ...
        public void EvaluateField(NameValueCollection FormData)
        {
            ...
            if (!vc.TrueContinue)
            {
                ...
                //MinimumSearchCharacterCssClass = MinimumSearchCharacterCssClass.AddHtmlClass(vc.WarningFieldClass["txt_MinimumSearchCharacter"]);
                //SearchedPerPageCssClass = SearchedPerPageCssClass.AddHtmlClass(vc.WarningFieldClass["txt_SearchedPerPage"]);
                //NextSearchDelayhCssClass = NextSearchDelayhCssClass.AddHtmlClass(vc.WarningFieldClass["txt_NextSearchDelay"]);
            }
        }
        ...
        public void SaveSearchOption()
        {
            ...
            SearchOptionDocument.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/extra_helper/search_option/option/search_option.xml"));
