...
namespace elanat
{
    public class ExtraHelperSignUpOptionModel
    {
        ...
        public void SetValue()
        {
            ...
            SignUpOptionDocument.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/extra_helper/sign_up_option/option/sign_up_option.xml"));
        ...
        public void SaveSignUpOption()
        {
            ...
            SignUpOptionDocument.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/extra_helper/sign_up_option/option/sign_up_option.xml"));
