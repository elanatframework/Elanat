...
namespace elanat
{
    public class PluginShowMemberPageModel
    {
        public void SetValue()
        {
            ...
            HttpContext.Current.Response.Write(MemberPageBoxTemplate.Replace("$_asp item;", SumMemberPageListItemTemplate).Replace("$_asp site_path;", StaticObject.SitePath));
        }
    }
}