...
namespace elanat
{
    public class PluginSiteShowPageModel
    {
        public void SetValue()
        {
            ...
            HttpContext.Current.Response.Write(PageBoxTemplate.Replace("$_asp item;", SumPathListItemTemplate).Replace("$_asp site_path;", StaticObject.SitePath));
        }
    }
}