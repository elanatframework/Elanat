...
namespace elanat
{
    public class ModuleTodayActivityOptionModel
    {
        ...
        public void SetValue()
        {
            ...
            TodayActivityOptionDocument.Load(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/module/today_activity/option/today_activity_option.xml"));
        ...
        public void SaveTodayActivityOption()
        {
            ...
            TodayActivityOptionDocument.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/module/today_activity/option/today_activity_option.xml"));
