...
namespace elanat
{
    public class ModuleInformationOptionModel
    {
        ...
        public void SaveInformationOption()
        {
            ...
            InformationOptionDocument.Save(HttpContext.Current.Server.MapPath(StaticObject.SitePath + "add_on/module/information/option/information_option.xml"));
