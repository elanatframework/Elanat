...
tinymce.init({valid_elements: '*[*]', allow_events: true, relative_urls : false, remove_script_host : true, document_base_url : "/", convert_urls : true, selector: 'textarea.el_load_wysiwyg', plugins: 'directionality lists table advlist hr link textcolor visualchars searchreplace code preview image media charmap anchor insertdatetime print textpattern fullscreen wordcount visualblocks nonbreaking template readmore htmlinput', toolbar: 'undo redo | ltr rtl | outdent indent | bold  italic underline strikethrough superscript subscript | alignleft aligncenter alignright alignjustify bullist numlist | link unlink forecolor backcolor removeformat readmore | table hr image media charmap template |  code preview searchreplace visualblocks fullscreen | fontselect fontsizeselect htmlinput', content_css: '../../../client/style/global.css'});