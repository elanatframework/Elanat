...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  var keywords = words(
    ...
    "function generate genvar global highz0 highz1 iff ifnone ignore_bins illegal_bins implements implies import " +
  ...
  */
  ...
  var statementKeywords = words("always always_comb always_ff always_latch assert assign assume else export for foreach forever import initial repeat while");
