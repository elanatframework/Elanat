...
CodeMirror.defineMode("kotlin", function (config, parserConfig) {
  ...
  var keywords = words(
          ...
          " when type this else This try val var fun for is in do as true false null get set");
  ...
  var blockKeywords = words("catch class do else finally for where try while enum");
