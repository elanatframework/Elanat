...
namespace elanat
{
    public class SiteSitemapWriterModel
    {
        public void SetValue(NameValueCollection QueryString)
        {
            ...
            if (QueryString["site"] != null)
                SiteGlobalName = QueryString["site"].ToString();
            ...
            {
                lc.FillSiteGlobalNameListItem();

                foreach (ListItem item in lc.SiteGlobalNameListItem)
                {
                ...
                HttpContext.Current.Response.Write(SitemapBoxStruct);
            ...
            HttpContext.Current.Response.Write(UrlBoxStruct);
